...
80100a92:	75 d2                	jne    80100a66 <exec+0x56>
  if((pgdir = setupkvm()) == 0)
80100a94:	e8 e7 62 00 00       	call   80106d80 <setupkvm>
...
80100b72:	e8 89 61 00 00       	call   80106d00 <freevm>
...
80100bc1:	e8 3a 61 00 00       	call   80106d00 <freevm>
...
80100c06:	e8 15 62 00 00       	call   80106e20 <clearpteu>
  for(argc = 0; argv[argc]; argc++) {
...
80100c5d:	e8 ae 64 00 00       	call   80107110 <copyout>
...
80100cc1:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100cc7:	e8 44 64 00 00       	call   80107110 <copyout>
...
80100d3c:	e8 bf 5f 00 00       	call   80106d00 <freevm>
  return 0;
...
801011b4:	68 7f 72 10 80       	push   $0x8010727f
...
801011f5:	e8 76 33 00 00       	call   80104570 <memset>
  log_write(bp);
...
801012e2:	68 95 72 10 80       	push   $0x80107295
...
801013b7:	68 a5 72 10 80       	push   $0x801072a5
...
801013f1:	e8 2a 32 00 00       	call   80104620 <memmove>
  brelse(bp);
...
80101484:	68 b8 72 10 80       	push   $0x801072b8
...
8010149c:	68 cb 72 10 80       	push   $0x801072cb
...
801014b3:	68 d2 72 10 80       	push   $0x801072d2
801014b8:	53                   	push   %ebx
801014b9:	81 c3 90 00 00 00    	add    $0x90,%ebx
801014bf:	e8 2c 2d 00 00       	call   801041f0 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
80101509:	68 38 73 10 80       	push   $0x80107338
...
8010159e:	e8 cd 2f 00 00       	call   80104570 <memset>
      dip->type = type;
...
801015d3:	68 d8 72 10 80       	push   $0x801072d8
...
80101641:	e8 da 2f 00 00       	call   80104620 <memmove>
  log_write(bp);
...
801016b2:	e8 79 2b 00 00       	call   80104230 <acquiresleep>
  if(ip->valid == 0){
...
80101728:	e8 f3 2e 00 00       	call   80104620 <memmove>
    brelse(bp);
...
8010174d:	68 f0 72 10 80       	push   $0x801072f0
80101752:	e8 39 ec ff ff       	call   80100390 <panic>
    panic("ilock");
80101757:	83 ec 0c             	sub    $0xc,%esp
8010175a:	68 ea 72 10 80       	push   $0x801072ea
...
80101783:	e8 48 2b 00 00       	call   801042d0 <holdingsleep>
...
8010179e:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
8010179f:	e9 ec 2a 00 00       	jmp    80104290 <releasesleep>
    panic("iunlock");
801017a4:	83 ec 0c             	sub    $0xc,%esp
801017a7:	68 ff 72 10 80       	push   $0x801072ff
...
801017d0:	e8 5b 2a 00 00       	call   80104230 <acquiresleep>
...
801017ea:	e8 a1 2a 00 00       	call   80104290 <releasesleep>
  acquire(&icache.lock);
...
80101a15:	01 de                	add    %ebx,%esi
    memmove(dst, bp->data + off%BSIZE, m);
80101a17:	e8 04 2c 00 00       	call   80104620 <memmove>
    brelse(bp);
...
80101b13:	e8 08 2b 00 00       	call   80104620 <memmove>
    log_write(bp);
...
80101bae:	e8 dd 2a 00 00       	call   80104690 <strncmp>
}
80101bb3:	c9                   	leave  
80101bb4:	c3                   	ret    
...
80101c0d:	e8 7e 2a 00 00       	call   80104690 <strncmp>
      continue;
...
80101c52:	68 19 73 10 80       	push   $0x80107319
80101c57:	e8 34 e7 ff ff       	call   80100390 <panic>
    panic("dirlookup not DIR");
80101c5c:	83 ec 0c             	sub    $0xc,%esp
80101c5f:	68 07 73 10 80       	push   $0x80107307
...
80101d05:	e8 16 29 00 00       	call   80104620 <memmove>
    path++;
...
80101d98:	e8 83 28 00 00       	call   80104620 <memmove>
    name[len] = 0;
...
80101e8d:	e8 5e 28 00 00       	call   801046f0 <strncpy>
  de.inum = inum;
...
80101ecb:	68 28 73 10 80       	push   $0x80107328
80101ed0:	e8 bb e4 ff ff       	call   80100390 <panic>
    panic("dirlink");
80101ed5:	83 ec 0c             	sub    $0xc,%esp
80101ed8:	68 82 79 10 80       	push   $0x80107982
...
80101feb:	68 94 73 10 80       	push   $0x80107394
80101ff0:	e8 9b e3 ff ff       	call   80100390 <panic>
    panic("idestart");
80101ff5:	83 ec 0c             	sub    $0xc,%esp
80101ff8:	68 8b 73 10 80       	push   $0x8010738b
...
8010213e:	e8 8d 21 00 00       	call   801042d0 <holdingsleep>
...
8010220a:	68 c0 73 10 80       	push   $0x801073c0
8010220f:	e8 7c e1 ff ff       	call   80100390 <panic>
    panic("iderw: buf not locked");
80102214:	83 ec 0c             	sub    $0xc,%esp
80102217:	68 aa 73 10 80       	push   $0x801073aa
8010221c:	e8 6f e1 ff ff       	call   80100390 <panic>
    panic("iderw: ide disk 1 not present");
80102221:	83 ec 0c             	sub    $0xc,%esp
80102224:	68 d5 73 10 80       	push   $0x801073d5
...
80102257:	8b 0d 34 26 11 80    	mov    0x80112634,%ecx
  ...
  if(id != ioapicid)
8010225d:	0f b6 15 60 27 18 80 	movzbl 0x80182760,%edx
  maxintr = (ioapicread(REG_VER) >> 16) & 0xFF;
...
80102277:	68 f4 73 10 80       	push   $0x801073f4
...
80102332:	81 fb c4 34 19 80    	cmp    $0x801934c4,%ebx
...
80102352:	e8 19 22 00 00       	call   80104570 <memset>
...
801023a5:	68 26 74 10 80       	push   $0x80107426
...
8010240b:	68 2c 74 10 80       	push   $0x8010742c
...
{
  if(!lapic)
80102640:	a1 7c 26 18 80       	mov    0x8018267c,%eax
{
...
{
  if (!lapic)
80102740:	8b 15 7c 26 18 80    	mov    0x8018267c,%edx
{
...
{
  if(lapic)
80102760:	a1 7c 26 18 80       	mov    0x8018267c,%eax
{
...
801027c8:	66 a3 69 04 00 80    	mov    %ax,0x80000469
  lapic[index] = value;
801027ce:	a1 7c 26 18 80       	mov    0x8018267c,%eax
...
80102947:	e8 74 1c 00 00       	call   801045c0 <memcmp>
...
80102a10:	8b 0d c8 26 18 80    	mov    0x801826c8,%ecx
...
80102a30:	a1 b4 26 18 80       	mov    0x801826b4,%eax
80102a35:	83 ec 08             	sub    $0x8,%esp
80102a38:	01 d8                	add    %ebx,%eax
80102a3a:	83 c0 01             	add    $0x1,%eax
80102a3d:	50                   	push   %eax
80102a3e:	ff 35 c4 26 18 80    	pushl  0x801826c4
80102a44:	e8 87 d6 ff ff       	call   801000d0 <bread>
80102a49:	89 c7                	mov    %eax,%edi
    struct buf *dbuf = bread(log.dev, log.lh.block[tail]); // read dst
80102a4b:	58                   	pop    %eax
80102a4c:	5a                   	pop    %edx
80102a4d:	ff 34 9d cc 26 18 80 	pushl  -0x7fe7d934(,%ebx,4)
80102a54:	ff 35 c4 26 18 80    	pushl  0x801826c4
  for (tail = 0; tail < log.lh.n; tail++) {
...
80102a74:	e8 a7 1b 00 00       	call   80104620 <memmove>
...
80102a94:	39 1d c8 26 18 80    	cmp    %ebx,0x801826c8
...
80102ab8:	ff 35 b4 26 18 80    	pushl  0x801826b4
80102abe:	ff 35 c4 26 18 80    	pushl  0x801826c4
80102ac4:	e8 07 d6 ff ff       	call   801000d0 <bread>
  struct logheader *hb = (struct logheader *) (buf->data);
  int i;
  hb->n = log.lh.n;
80102ac9:	8b 1d c8 26 18 80    	mov    0x801826c8,%ebx
...
80102ae0:	8b 8a cc 26 18 80    	mov    -0x7fe7d934(%edx),%ecx
...
80102b1a:	68 60 76 10 80       	push   $0x80107660
80102b1f:	68 80 26 18 80       	push   $0x80182680
...
80102b3b:	59                   	pop    %ecx
  log.dev = dev;
80102b3c:	89 1d c4 26 18 80    	mov    %ebx,0x801826c4
  log.size = sb.nlog;
80102b42:	89 15 b8 26 18 80    	mov    %edx,0x801826b8
  log.start = sb.logstart;
80102b48:	a3 b4 26 18 80       	mov    %eax,0x801826b4
  struct buf *buf = bread(log.dev, log.start);
80102b4d:	5a                   	pop    %edx
...
80102b5b:	85 db                	test   %ebx,%ebx
  log.lh.n = lh->n;
80102b5d:	89 1d c8 26 18 80    	mov    %ebx,0x801826c8
  for (i = 0; i < log.lh.n; i++) {
...
80102b77:	89 8a c8 26 18 80    	mov    %ecx,-0x7fe7d938(%edx)
  for (i = 0; i < log.lh.n; i++) {
...
80102b8a:	e8 81 fe ff ff       	call   80102a10 <install_trans>
  log.lh.n = 0;
80102b8f:	c7 05 c8 26 18 80 00 	movl   $0x0,0x801826c8
80102b96:	00 00 00 
...
80102bb3:	83 ec 14             	sub    $0x14,%esp
  acquire(&log.lock);
80102bb6:	68 80 26 18 80       	push   $0x80182680
...
80102bcb:	68 80 26 18 80       	push   $0x80182680
80102bd0:	68 80 26 18 80       	push   $0x80182680
80102bd5:	e8 b6 11 00 00       	call   80103d90 <sleep>
80102bda:	83 c4 10             	add    $0x10,%esp
    if(log.committing){
80102bdd:	a1 c0 26 18 80       	mov    0x801826c0,%eax
80102be2:	85 c0                	test   %eax,%eax
80102be4:	75 e2                	jne    80102bc8 <begin_op+0x18>
    } else if(log.lh.n + (log.outstanding+1)*MAXOPBLOCKS > LOGSIZE){
80102be6:	a1 bc 26 18 80       	mov    0x801826bc,%eax
80102beb:	8b 15 c8 26 18 80    	mov    0x801826c8,%edx
...
80102bff:	83 ec 0c             	sub    $0xc,%esp
      log.outstanding += 1;
80102c02:	a3 bc 26 18 80       	mov    %eax,0x801826bc
      release(&log.lock);
80102c07:	68 80 26 18 80       	push   $0x80182680
...
80102c26:	83 ec 18             	sub    $0x18,%esp
  ...
  acquire(&log.lock);
80102c29:	68 80 26 18 80       	push   $0x80182680
80102c2e:	e8 2d 18 00 00       	call   80104460 <acquire>
  log.outstanding -= 1;
80102c33:	a1 bc 26 18 80       	mov    0x801826bc,%eax
  if(log.committing)
80102c38:	8b 35 c0 26 18 80    	mov    0x801826c0,%esi
...
80102c44:	85 f6                	test   %esi,%esi
  log.outstanding -= 1;
80102c46:	89 1d bc 26 18 80    	mov    %ebx,0x801826bc
  if(log.committing)
...
80102c5a:	83 ec 0c             	sub    $0xc,%esp
    log.committing = 1;
80102c5d:	c7 05 c0 26 18 80 01 	movl   $0x1,0x801826c0
80102c64:	00 00 00 
  release(&log.lock);
80102c67:	68 80 26 18 80       	push   $0x80182680
...
{
  if (log.lh.n > 0) {
80102c71:	8b 0d c8 26 18 80    	mov    0x801826c8,%ecx
80102c77:	83 c4 10             	add    $0x10,%esp
80102c7a:	85 c9                	test   %ecx,%ecx
80102c7c:	0f 8e 85 00 00 00    	jle    80102d07 <end_op+0xe7>
    struct buf *to = bread(log.dev, log.start+tail+1); // log block
80102c82:	a1 b4 26 18 80       	mov    0x801826b4,%eax
80102c87:	83 ec 08             	sub    $0x8,%esp
80102c8a:	01 d8                	add    %ebx,%eax
80102c8c:	83 c0 01             	add    $0x1,%eax
80102c8f:	50                   	push   %eax
80102c90:	ff 35 c4 26 18 80    	pushl  0x801826c4
80102c96:	e8 35 d4 ff ff       	call   801000d0 <bread>
80102c9b:	89 c6                	mov    %eax,%esi
    struct buf *from = bread(log.dev, log.lh.block[tail]); // cache block
80102c9d:	58                   	pop    %eax
80102c9e:	5a                   	pop    %edx
80102c9f:	ff 34 9d cc 26 18 80 	pushl  -0x7fe7d934(,%ebx,4)
80102ca6:	ff 35 c4 26 18 80    	pushl  0x801826c4
  for (tail = 0; tail < log.lh.n; tail++) {
...
80102cc6:	e8 55 19 00 00       	call   80104620 <memmove>
...
80102ce6:	3b 1d c8 26 18 80    	cmp    0x801826c8,%ebx
...
80102cf3:	e8 18 fd ff ff       	call   80102a10 <install_trans>
    log.lh.n = 0;
80102cf8:	c7 05 c8 26 18 80 00 	movl   $0x0,0x801826c8
80102cff:	00 00 00 
    write_head();    // Erase the transaction from the log
80102d02:	e8 a9 fd ff ff       	call   80102ab0 <write_head>
    acquire(&log.lock);
80102d07:	83 ec 0c             	sub    $0xc,%esp
80102d0a:	68 80 26 18 80       	push   $0x80182680
80102d0f:	e8 4c 17 00 00       	call   80104460 <acquire>
    wakeup(&log);
80102d14:	c7 04 24 80 26 18 80 	movl   $0x80182680,(%esp)
    log.committing = 0;
80102d1b:	c7 05 c0 26 18 80 00 	movl   $0x0,0x801826c0
80102d22:	00 00 00 
    wakeup(&log);
80102d25:	e8 16 12 00 00       	call   80103f40 <wakeup>
    release(&log.lock);
80102d2a:	c7 04 24 80 26 18 80 	movl   $0x80182680,(%esp)
...
80102d4b:	68 80 26 18 80       	push   $0x80182680
80102d50:	e8 eb 11 00 00       	call   80103f40 <wakeup>
  release(&log.lock);
80102d55:	c7 04 24 80 26 18 80 	movl   $0x80182680,(%esp)
...
80102d6f:	68 64 76 10 80       	push   $0x80107664
...
80102d87:	8b 15 c8 26 18 80    	mov    0x801826c8,%edx
{
80102d8d:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if (log.lh.n >= LOGSIZE || log.lh.n >= log.size - 1)
80102d90:	83 fa 1d             	cmp    $0x1d,%edx
80102d93:	0f 8f 9d 00 00 00    	jg     80102e36 <log_write+0xb6>
80102d99:	a1 b8 26 18 80       	mov    0x801826b8,%eax
80102d9e:	83 e8 01             	sub    $0x1,%eax
80102da1:	39 c2                	cmp    %eax,%edx
80102da3:	0f 8d 8d 00 00 00    	jge    80102e36 <log_write+0xb6>
    panic("too big a transaction");
  if (log.outstanding < 1)
80102da9:	a1 bc 26 18 80       	mov    0x801826bc,%eax
...
80102db9:	68 80 26 18 80       	push   $0x80182680
80102dbe:	e8 9d 16 00 00       	call   80104460 <acquire>
  for (i = 0; i < log.lh.n; i++) {
80102dc3:	8b 0d c8 26 18 80    	mov    0x801826c8,%ecx
...
80102dd4:	31 c0                	xor    %eax,%eax
    if (log.lh.block[i] == b->blockno)   // log absorbtion
80102dd6:	3b 15 cc 26 18 80    	cmp    0x801826cc,%edx
80102ddc:	75 0b                	jne    80102de9 <log_write+0x69>
80102dde:	eb 38                	jmp    80102e18 <log_write+0x98>
80102de0:	39 14 85 cc 26 18 80 	cmp    %edx,-0x7fe7d934(,%eax,4)
...
80102df0:	89 14 85 cc 26 18 80 	mov    %edx,-0x7fe7d934(,%eax,4)
  if (i == log.lh.n)
    log.lh.n++;
80102df7:	83 c0 01             	add    $0x1,%eax
80102dfa:	a3 c8 26 18 80       	mov    %eax,0x801826c8
  b->flags |= B_DIRTY; // prevent eviction
80102dff:	83 0b 04             	orl    $0x4,(%ebx)
  release(&log.lock);
80102e02:	c7 45 08 80 26 18 80 	movl   $0x80182680,0x8(%ebp)
}
...
80102e12:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  log.lh.block[i] = b->blockno;
80102e18:	89 14 85 cc 26 18 80 	mov    %edx,-0x7fe7d934(,%eax,4)
80102e1f:	eb de                	jmp    80102dff <log_write+0x7f>
80102e21:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80102e28:	8b 43 08             	mov    0x8(%ebx),%eax
80102e2b:	a3 cc 26 18 80       	mov    %eax,0x801826cc
  if (i == log.lh.n)
...
80102e39:	68 73 76 10 80       	push   $0x80107673
80102e3e:	e8 4d d5 ff ff       	call   80100390 <panic>
    panic("log_write outside of trans");
80102e43:	83 ec 0c             	sub    $0xc,%esp
80102e46:	68 89 76 10 80       	push   $0x80107689
...
80102e68:	68 a4 76 10 80       	push   $0x801076a4
...
80102ec7:	68 c4 34 19 80       	push   $0x801934c4
80102ecc:	e8 2f f5 ff ff       	call   80102400 <kinit1>
  kvmalloc();      // kernel page table
80102ed1:	e8 2a 3f 00 00       	call   80106e00 <kvmalloc>
...
80102f24:	e8 f7 16 00 00       	call   80104620 <memmove>

  for(c = cpus; c < cpus+ncpu; c++){
80102f29:	69 05 00 2d 18 80 b0 	imul   $0xb0,0x80182d00,%eax
80102f30:	00 00 00 
80102f33:	83 c4 10             	add    $0x10,%esp
80102f36:	05 80 27 18 80       	add    $0x80182780,%eax
80102f3b:	3d 80 27 18 80       	cmp    $0x80182780,%eax
80102f40:	76 71                	jbe    80102fb3 <main+0x103>
80102f42:	bb 80 27 18 80       	mov    $0x80182780,%ebx
...
80102f98:	74 f6                	je     80102f90 <main+0xe0>
  for(c = cpus; c < cpus+ncpu; c++){
80102f9a:	69 05 00 2d 18 80 b0 	imul   $0xb0,0x80182d00,%eax
80102fa1:	00 00 00 
80102fa4:	81 c3 b0 00 00 00    	add    $0xb0,%ebx
80102faa:	05 80 27 18 80       	add    $0x80182780,%eax
...
80102ffe:	68 b8 76 10 80       	push   $0x801076b8
80103003:	56                   	push   %esi
80103004:	e8 b7 15 00 00       	call   801045c0 <memcmp>
...
801030bc:	68 d5 76 10 80       	push   $0x801076d5
801030c1:	56                   	push   %esi
801030c2:	e8 f9 14 00 00       	call   801045c0 <memcmp>
...
80103127:	a3 7c 26 18 80       	mov    %eax,0x8018267c
...
80103150:	ff 24 95 fc 76 10 80 	jmp    *-0x7fef8904(,%edx,4)
...
80103195:	8d 76 00             	lea    0x0(%esi),%esi
      if(ncpu < NCPU) {
80103198:	8b 0d 00 2d 18 80    	mov    0x80182d00,%ecx
...
801031b0:	89 0d 00 2d 18 80    	mov    %ecx,0x80182d00
        cpus[ncpu].apicid = proc->apicid;  // apicid may differ from ncpu
801031b6:	88 97 80 27 18 80    	mov    %dl,-0x7fe7d880(%edi)
...
801031cc:	83 c0 08             	add    $0x8,%eax
      ioapicid = ioapic->apicno;
801031cf:	88 15 60 27 18 80    	mov    %dl,0x80182760
      continue;
...
80103203:	68 bd 76 10 80       	push   $0x801076bd
80103208:	e8 83 d1 ff ff       	call   80100390 <panic>
    panic("Didn't find a suitable machine");
8010320d:	83 ec 0c             	sub    $0xc,%esp
80103210:	68 dc 76 10 80       	push   $0x801076dc
...
80103308:	00 00 00 
  initlock(&p->lock, "pipe");
8010330b:	68 10 77 10 80       	push   $0x80107710
...
80103614:	bb 54 2d 18 80       	mov    $0x80182d54,%ebx
{
80103619:	83 ec 10             	sub    $0x10,%esp
  acquire(&ptable.lock);
8010361c:	68 20 2d 18 80       	push   $0x80182d20
...
80103633:	81 fb 54 4c 18 80    	cmp    $0x80184c54,%ebx
...
80103654:	89 43 10             	mov    %eax,0x10(%ebx)
  release(&ptable.lock);
80103657:	68 20 2d 18 80       	push   $0x80182d20
  p->pid = nextpid++;
8010365c:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
80103662:	e8 b9 0e 00 00       	call   80104520 <release>
...
80103684:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103687:	c7 40 14 71 57 10 80 	movl   $0x80105771,0x14(%eax)
  p->context = (struct context*)sp;
...
80103696:	e8 d5 0e 00 00       	call   80104570 <memset>
...
801036b3:	31 db                	xor    %ebx,%ebx
  release(&ptable.lock);
801036b5:	68 20 2d 18 80       	push   $0x80182d20
801036ba:	e8 61 0e 00 00       	call   80104520 <release>
}
...
801036e3:	83 ec 14             	sub    $0x14,%esp
  ...
  release(&ptable.lock);
801036e6:	68 20 2d 18 80       	push   $0x80182d20
...
80103736:	68 15 77 10 80       	push   $0x80107715
8010373b:	68 20 2d 18 80       	push   $0x80182d20
...
8010375c:	e8 df ef ff ff       	call   80102740 <lapicid>
  for (i = 0; i < ncpu; ++i) {
80103761:	8b 35 00 2d 18 80    	mov    0x80182d00,%esi
80103767:	85 f6                	test   %esi,%esi
80103769:	7e 42                	jle    801037ad <mycpu+0x5d>
    if (cpus[i].apicid == apicid)
8010376b:	0f b6 15 80 27 18 80 	movzbl 0x80182780,%edx
80103772:	39 d0                	cmp    %edx,%eax
80103774:	74 30                	je     801037a6 <mycpu+0x56>
80103776:	b9 30 28 18 80       	mov    $0x80182830,%ecx
  for (i = 0; i < ncpu; ++i) {
...
8010379a:	05 80 27 18 80       	add    $0x80182780,%eax
}
...
801037db:	2d 80 27 18 80       	sub    $0x80182780,%eax
}
801037e0:	c9                   	leave  
  return mycpu()-cpus;
...
801037f4:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801037f7:	e8 94 0b 00 00       	call   80104390 <pushcli>
  c = mycpu();
801037fc:	e8 4f ff ff ff       	call   80103750 <mycpu>
  p = c->proc;
80103801:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103807:	e8 c4 0b 00 00       	call   801043d0 <popcli>
}
...
80103833:	e8 48 35 00 00       	call   80106d80 <setupkvm>
...
80103866:	e8 05 0d 00 00       	call   80104570 <memset>
...
801038bf:	68 45 77 10 80       	push   $0x80107745
801038c4:	50                   	push   %eax
801038c5:	e8 86 0e 00 00       	call   80104750 <safestrcpy>
  p->cwd = namei("/");
801038ca:	c7 04 24 4e 77 10 80 	movl   $0x8010774e,(%esp)
801038d1:	e8 1a e6 ff ff       	call   80101ef0 <namei>
801038d6:	89 43 68             	mov    %eax,0x68(%ebx)
  acquire(&ptable.lock);
801038d9:	c7 04 24 20 2d 18 80 	movl   $0x80182d20,(%esp)
801038e0:	e8 7b 0b 00 00       	call   80104460 <acquire>
  p->state = RUNNABLE;
801038e5:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  release(&ptable.lock);
801038ec:	c7 04 24 20 2d 18 80 	movl   $0x80182d20,(%esp)
801038f3:	e8 28 0c 00 00       	call   80104520 <release>
}
...
80103903:	68 2c 77 10 80       	push   $0x8010772c
...
80103915:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103918:	e8 73 0a 00 00       	call   80104390 <pushcli>
  c = mycpu();
8010391d:	e8 2e fe ff ff       	call   80103750 <mycpu>
  p = c->proc;
80103922:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103928:	e8 a3 0a 00 00       	call   801043d0 <popcli>
  if(n > 0){
...
8010397a:	e8 51 33 00 00       	call   80106cd0 <deallocuvm>
...
80103996:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103999:	e8 f2 09 00 00       	call   80104390 <pushcli>
  c = mycpu();
8010399e:	e8 ad fd ff ff       	call   80103750 <mycpu>
  p = c->proc;
801039a3:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801039a9:	e8 22 0a 00 00       	call   801043d0 <popcli>
  if((np = allocproc()) == 0){
...
801039c8:	e8 63 36 00 00       	call   80107030 <copyuvm>
...
80103a41:	e8 0a 0d 00 00       	call   80104750 <safestrcpy>
  pid = np->pid;
80103a46:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103a49:	c7 04 24 20 2d 18 80 	movl   $0x80182d20,(%esp)
80103a50:	e8 0b 0a 00 00       	call   80104460 <acquire>
  np->state = RUNNABLE;
80103a55:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  release(&ptable.lock);
80103a5c:	c7 04 24 20 2d 18 80 	movl   $0x80182d20,(%esp)
80103a63:	e8 b8 0a 00 00       	call   80104520 <release>
  return pid;
...
80103ad1:	83 ec 0c             	sub    $0xc,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ad4:	bb 54 2d 18 80       	mov    $0x80182d54,%ebx
    acquire(&ptable.lock);
80103ad9:	68 20 2d 18 80       	push   $0x80182d20
80103ade:	e8 7d 09 00 00       	call   80104460 <acquire>
...
80103b0b:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103b12:	e8 94 0c 00 00       	call   801047ab <swtch>
      switchkvm();
...
80103b2c:	81 fb 54 4c 18 80    	cmp    $0x80184c54,%ebx
80103b32:	72 bc                	jb     80103af0 <scheduler+0x40>
    release(&ptable.lock);
80103b34:	83 ec 0c             	sub    $0xc,%esp
80103b37:	68 20 2d 18 80       	push   $0x80182d20
80103b3c:	e8 df 09 00 00       	call   80104520 <release>
    sti();
...
80103b54:	53                   	push   %ebx
  pushcli();
80103b55:	e8 36 08 00 00       	call   80104390 <pushcli>
  c = mycpu();
80103b5a:	e8 f1 fb ff ff       	call   80103750 <mycpu>
  p = c->proc;
80103b5f:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b65:	e8 66 08 00 00       	call   801043d0 <popcli>
  if(!holding(&ptable.lock))
80103b6a:	83 ec 0c             	sub    $0xc,%esp
80103b6d:	68 20 2d 18 80       	push   $0x80182d20
80103b72:	e8 b9 08 00 00       	call   80104430 <holding>
...
80103bb3:	e8 f3 0b 00 00       	call   801047ab <swtch>
  mycpu()->intena = intena;
...
80103c16:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103c19:	e8 72 07 00 00       	call   80104390 <pushcli>
  c = mycpu();
80103c1e:	e8 2d fb ff ff       	call   80103750 <mycpu>
  p = c->proc;
80103c23:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103c29:	e8 a2 07 00 00       	call   801043d0 <popcli>
  if(curproc == initproc)
...
80103c74:	c7 46 68 00 00 00 00 	movl   $0x0,0x68(%esi)
  acquire(&ptable.lock);
80103c7b:	c7 04 24 20 2d 18 80 	movl   $0x80182d20,(%esp)
80103c82:	e8 d9 07 00 00       	call   80104460 <acquire>
...
80103ce7:	75 e7                	jne    80103cd0 <exit+0xc0>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103ce9:	b8 54 2d 18 80       	mov    $0x80182d54,%eax
80103cee:	eb 0a                	jmp    80103cfa <exit+0xea>
80103cf0:	83 c0 7c             	add    $0x7c,%eax
80103cf3:	3d 54 4c 18 80       	cmp    $0x80184c54,%eax
...
80103d1d:	68 9d 77 10 80       	push   $0x8010779d
80103d22:	e8 69 c6 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103d27:	83 ec 0c             	sub    $0xc,%esp
80103d2a:	68 90 77 10 80       	push   $0x80107790
...
80103d47:	68 20 2d 18 80       	push   $0x80182d20
80103d4c:	e8 0f 07 00 00       	call   80104460 <acquire>
  pushcli();
80103d51:	e8 3a 06 00 00       	call   80104390 <pushcli>
  c = mycpu();
80103d56:	e8 f5 f9 ff ff       	call   80103750 <mycpu>
  p = c->proc;
80103d5b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103d61:	e8 6a 06 00 00       	call   801043d0 <popcli>
  myproc()->state = RUNNABLE;
80103d66:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  sched();
80103d6d:	e8 de fd ff ff       	call   80103b50 <sched>
  release(&ptable.lock);
80103d72:	c7 04 24 20 2d 18 80 	movl   $0x80182d20,(%esp)
80103d79:	e8 a2 07 00 00       	call   80104520 <release>
}
...
80103d9c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103d9f:	e8 ec 05 00 00       	call   80104390 <pushcli>
  c = mycpu();
80103da4:	e8 a7 f9 ff ff       	call   80103750 <mycpu>
  p = c->proc;
80103da9:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103daf:	e8 1c 06 00 00       	call   801043d0 <popcli>
  if(p == 0)
...
80103dc0:	81 fe 20 2d 18 80    	cmp    $0x80182d20,%esi
80103dc6:	74 50                	je     80103e18 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
80103dc8:	83 ec 0c             	sub    $0xc,%esp
80103dcb:	68 20 2d 18 80       	push   $0x80182d20
80103dd0:	e8 8b 06 00 00       	call   80104460 <acquire>
    release(lk);
80103dd5:	89 34 24             	mov    %esi,(%esp)
80103dd8:	e8 43 07 00 00       	call   80104520 <release>
  p->chan = chan;
...
80103dec:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
    release(&ptable.lock);
80103df3:	c7 04 24 20 2d 18 80 	movl   $0x80182d20,(%esp)
80103dfa:	e8 21 07 00 00       	call   80104520 <release>
    acquire(lk);
...
80103e0b:	5d                   	pop    %ebp
    acquire(lk);
80103e0c:	e9 4f 06 00 00       	jmp    80104460 <acquire>
...
80103e39:	68 af 77 10 80       	push   $0x801077af
80103e3e:	e8 4d c5 ff ff       	call   80100390 <panic>
    panic("sleep");
80103e43:	83 ec 0c             	sub    $0xc,%esp
80103e46:	68 a9 77 10 80       	push   $0x801077a9
...
80103ea1:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ea6:	81 fb 54 4c 18 80    	cmp    $0x80184c54,%ebx
...
80103ebc:	68 20 2d 18 80       	push   $0x80182d20
...
80103ee2:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103ee9:	e8 12 2e 00 00       	call   80106d00 <freevm>
        release(&ptable.lock);
80103eee:	c7 04 24 20 2d 18 80 	movl   $0x80182d20,(%esp)
        p->pid = 0;
...
80103f0e:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103f15:	e8 06 06 00 00       	call   80104520 <release>
        return pid;
...
80103f29:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
80103f2e:	68 20 2d 18 80       	push   $0x80182d20
80103f33:	e8 e8 05 00 00       	call   80104520 <release>
      return -1;
...
80103f47:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ptable.lock);
80103f4a:	68 20 2d 18 80       	push   $0x80182d20
80103f4f:	e8 0c 05 00 00       	call   80104460 <acquire>
80103f54:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103f57:	b8 54 2d 18 80       	mov    $0x80182d54,%eax
80103f5c:	eb 0c                	jmp    80103f6a <wakeup+0x2a>
80103f5e:	66 90                	xchg   %ax,%ax
80103f60:	83 c0 7c             	add    $0x7c,%eax
80103f63:	3d 54 4c 18 80       	cmp    $0x80184c54,%eax
...
80103f7f:	3d 54 4c 18 80       	cmp    $0x80184c54,%eax
80103f84:	72 e4                	jb     80103f6a <wakeup+0x2a>
  wakeup1(chan);
  release(&ptable.lock);
80103f86:	c7 45 08 20 2d 18 80 	movl   $0x80182d20,0x8(%ebp)
}
80103f8d:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80103f90:	c9                   	leave  
  release(&ptable.lock);
80103f91:	e9 8a 05 00 00       	jmp    80104520 <release>
...
80103fe6:	68 20 2d 18 80       	push   $0x80182d20
80103feb:	e8 30 05 00 00       	call   80104520 <release>
      return 0;
...
80104003:	68 20 2d 18 80       	push   $0x80182d20
80104008:	e8 13 05 00 00       	call   80104520 <release>
  return -1;
...
80104025:	53                   	push   %ebx
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104026:	bf 54 2d 18 80       	mov    $0x80182d54,%edi
{
8010402b:	83 ec 4c             	sub    $0x4c,%esp
8010402e:	66 90                	xchg   %ax,%ax
    if(p->state == UNUSED)
80104030:	8b 47 0c             	mov    0xc(%edi),%eax
80104033:	85 c0                	test   %eax,%eax
80104035:	0f 84 45 01 00 00    	je     80104180 <procdump+0x160>
      continue;
...
8010403b:	83 f8 05             	cmp    $0x5,%eax
      ...
      state = "???";
8010403e:	b9 c0 77 10 80       	mov    $0x801077c0,%ecx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104043:	77 11                	ja     80104056 <procdump+0x36>
80104045:	8b 0c 85 74 78 10 80 	mov    -0x7fef878c(,%eax,4),%ecx
      state = "???";
8010404c:	b8 c0 77 10 80       	mov    $0x801077c0,%eax
80104051:	85 c9                	test   %ecx,%ecx
80104053:	0f 44 c8             	cmove  %eax,%ecx

    cprintf("%d %s %s", p->pid, state, p->name);
80104056:	8d 47 6c             	lea    0x6c(%edi),%eax
80104059:	50                   	push   %eax
8010405a:	51                   	push   %ecx
8010405b:	ff 77 10             	pushl  0x10(%edi)
8010405e:	68 cb 77 10 80       	push   $0x801077cb
80104063:	e8 f8 c5 ff ff       	call   80100660 <cprintf>

    if(p->state == SLEEPING){
80104068:	83 c4 10             	add    $0x10,%esp
8010406b:	83 7f 0c 02          	cmpl   $0x2,0xc(%edi)
8010406f:	0f 84 22 01 00 00    	je     80104197 <procdump+0x177>
...
80104078:	68 e3 7b 10 80       	push   $0x80107be3
8010407d:	e8 de c5 ff ff       	call   80100660 <cprintf>
...
80104089:	0f 84 f1 00 00 00    	je     80104180 <procdump+0x160>
  if(*pde & PTE_P){
8010408f:	8b 47 04             	mov    0x4(%edi),%eax
80104092:	8b 00                	mov    (%eax),%eax
80104094:	a8 01                	test   $0x1,%al
80104096:	74 68                	je     80104100 <procdump+0xe0>
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80104098:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010409d:	89 c1                	mov    %eax,%ecx
8010409f:	8d 80 00 00 00 80    	lea    -0x80000000(%eax),%eax
		// 
		if((pte = walkpgdir(p->pgdir, (void *) i, 0)) == 0)
801040a5:	81 f9 00 00 00 80    	cmp    $0x80000000,%ecx
801040ab:	74 53                	je     80104100 <procdump+0xe0>
	for (uint i = 0; i < p->sz; i += PGSIZE) {
...
801040af:	90                   	nop
	    ...
	    if(!(*pte & PTE_P))
801040b0:	8b 30                	mov    (%eax),%esi
801040b2:	f7 c6 01 00 00 00    	test   $0x1,%esi
801040b8:	0f 84 21 01 00 00    	je     801041df <procdump+0x1bf>
	      panic("copyuvm: page not present");
		
		if((*pte & PTE_U) && (*pte & PTE_P)){
801040be:	89 f2                	mov    %esi,%edx
801040c0:	83 e2 05             	and    $0x5,%edx
801040c3:	83 fa 05             	cmp    $0x5,%edx
801040c6:	74 48                	je     80104110 <procdump+0xf0>
	for (uint i = 0; i < p->sz; i += PGSIZE) {
801040c8:	81 c3 00 10 00 00    	add    $0x1000,%ebx
801040ce:	39 1f                	cmp    %ebx,(%edi)
801040d0:	0f 86 aa 00 00 00    	jbe    80104180 <procdump+0x160>
  if(*pde & PTE_P){
801040d6:	8b 47 04             	mov    0x4(%edi),%eax
  pde = &pgdir[PDX(va)];
801040d9:	89 da                	mov    %ebx,%edx
801040db:	c1 ea 16             	shr    $0x16,%edx
  if(*pde & PTE_P){
801040de:	8b 04 90             	mov    (%eax,%edx,4),%eax
801040e1:	a8 01                	test   $0x1,%al
801040e3:	74 1b                	je     80104100 <procdump+0xe0>
  return &pgtab[PTX(va)];
801040e5:	89 da                	mov    %ebx,%edx
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
801040e7:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  return &pgtab[PTX(va)];
801040ec:	c1 ea 0a             	shr    $0xa,%edx
801040ef:	81 e2 fc 0f 00 00    	and    $0xffc,%edx
801040f5:	8d 84 10 00 00 00 80 	lea    -0x80000000(%eax,%edx,1),%eax
		if((pte = walkpgdir(p->pgdir, (void *) i, 0)) == 0)
801040fc:	85 c0                	test   %eax,%eax
801040fe:	75 b0                	jne    801040b0 <procdump+0x90>
	      panic("copyuvm: pte should exist");
80104100:	83 ec 0c             	sub    $0xc,%esp
80104103:	68 d4 77 10 80       	push   $0x801077d4
80104108:	e8 83 c2 ff ff       	call   80100390 <panic>
8010410d:	8d 76 00             	lea    0x0(%esi),%esi
			uint temp = PTE_ADDR(*pte) >> 12;
			cprintf("| %d", PTX(i));
80104110:	89 da                	mov    %ebx,%edx
80104112:	83 ec 08             	sub    $0x8,%esp
80104115:	89 45 b4             	mov    %eax,-0x4c(%ebp)
80104118:	c1 ea 0c             	shr    $0xc,%edx
			uint temp = PTE_ADDR(*pte) >> 12;
8010411b:	c1 ee 0c             	shr    $0xc,%esi
			cprintf("| %d", PTX(i));
8010411e:	81 e2 ff 03 00 00    	and    $0x3ff,%edx
80104124:	52                   	push   %edx
80104125:	68 08 78 10 80       	push   $0x80107808
8010412a:	e8 31 c5 ff ff       	call   80100660 <cprintf>
			cprintf("| %d        ",temp);
8010412f:	58                   	pop    %eax
80104130:	5a                   	pop    %edx
80104131:	56                   	push   %esi
80104132:	68 0d 78 10 80       	push   $0x8010780d
80104137:	e8 24 c5 ff ff       	call   80100660 <cprintf>
			cprintf("| %s", (*pte & PTE_W) ? "Yes" : "No");
8010413c:	8b 45 b4             	mov    -0x4c(%ebp),%eax
8010413f:	59                   	pop    %ecx
80104140:	b9 c4 77 10 80       	mov    $0x801077c4,%ecx
80104145:	f6 00 02             	testb  $0x2,(%eax)
80104148:	b8 c8 77 10 80       	mov    $0x801077c8,%eax
8010414d:	5e                   	pop    %esi
8010414e:	0f 45 c1             	cmovne %ecx,%eax
	for (uint i = 0; i < p->sz; i += PGSIZE) {
80104151:	81 c3 00 10 00 00    	add    $0x1000,%ebx
			cprintf("| %s", (*pte & PTE_W) ? "Yes" : "No");
80104157:	50                   	push   %eax
80104158:	68 1a 78 10 80       	push   $0x8010781a
8010415d:	e8 fe c4 ff ff       	call   80100660 <cprintf>
			cprintf("|\n");
80104162:	c7 04 24 1f 78 10 80 	movl   $0x8010781f,(%esp)
80104169:	e8 f2 c4 ff ff       	call   80100660 <cprintf>
8010416e:	83 c4 10             	add    $0x10,%esp
	for (uint i = 0; i < p->sz; i += PGSIZE) {
80104171:	39 1f                	cmp    %ebx,(%edi)
80104173:	0f 87 5d ff ff ff    	ja     801040d6 <procdump+0xb6>
80104179:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104180:	83 c7 7c             	add    $0x7c,%edi
80104183:	81 ff 54 4c 18 80    	cmp    $0x80184c54,%edi
80104189:	0f 82 a1 fe ff ff    	jb     80104030 <procdump+0x10>
		}
...
80104196:	c3                   	ret    
      getcallerpcs((uint*)p->context->ebp+2, pc);
80104197:	8b 47 1c             	mov    0x1c(%edi),%eax
8010419a:	8d 5d c0             	lea    -0x40(%ebp),%ebx
8010419d:	83 ec 08             	sub    $0x8,%esp
801041a0:	8d 75 e8             	lea    -0x18(%ebp),%esi
801041a3:	53                   	push   %ebx
801041a4:	8b 40 0c             	mov    0xc(%eax),%eax
801041a7:	83 c0 08             	add    $0x8,%eax
801041aa:	50                   	push   %eax
801041ab:	e8 90 01 00 00       	call   80104340 <getcallerpcs>
...
801041bc:	0f 84 b3 fe ff ff    	je     80104075 <procdump+0x55>
        cprintf(" %p", pc[i]);
801041c2:	83 ec 08             	sub    $0x8,%esp
801041c5:	83 c3 04             	add    $0x4,%ebx
801041c8:	50                   	push   %eax
801041c9:	68 01 72 10 80       	push   $0x80107201
801041ce:	e8 8d c4 ff ff       	call   80100660 <cprintf>
      for(i=0; i<10 && pc[i] != 0; i++)
801041d3:	83 c4 10             	add    $0x10,%esp
801041d6:	39 de                	cmp    %ebx,%esi
801041d8:	75 de                	jne    801041b8 <procdump+0x198>
801041da:	e9 96 fe ff ff       	jmp    80104075 <procdump+0x55>
	      panic("copyuvm: page not present");
801041df:	83 ec 0c             	sub    $0xc,%esp
801041e2:	68 ee 77 10 80       	push   $0x801077ee
801041e7:	e8 a4 c1 ff ff       	call   80100390 <panic>
...
801041fa:	68 8c 78 10 80       	push   $0x8010788c
...
80104255:	e8 36 fb ff ff       	call   80103d90 <sleep>
  while (lk->locked) {
...
80104263:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104269:	e8 82 f5 ff ff       	call   801037f0 <myproc>
...
801042b4:	e8 87 fc ff ff       	call   80103f40 <wakeup>
  release(&lk->lk);
...
801042f3:	e8 f8 f4 ff ff       	call   801037f0 <myproc>
...
80104399:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
8010439a:	e8 b1 f3 ff ff       	call   80103750 <mycpu>
...
801043af:	e8 9c f3 ff ff       	call   80103750 <mycpu>
...
80104415:	68 97 78 10 80       	push   $0x80107897
8010441a:	e8 71 bf ff ff       	call   80100390 <panic>
    panic("popcli");
8010441f:	83 ec 0c             	sub    $0xc,%esp
80104422:	68 ae 78 10 80       	push   $0x801078ae
...
80104448:	e8 03 f3 ff ff       	call   80103750 <mycpu>
...
801044a4:	e8 a7 f2 ff ff       	call   80103750 <mycpu>
...
80104507:	68 b5 78 10 80       	push   $0x801078b5
...
8010455c:	68 bd 78 10 80       	push   $0x801078bd
...
80104807:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
8010480a:	e8 e1 ef ff ff       	call   801037f0 <myproc>
...
80104883:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104886:	e8 65 ef ff ff       	call   801037f0 <myproc>
  if(addr >= curproc->sz || addr+4 > curproc->sz)
...
801048c8:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
801048cb:	e8 20 ef ff ff       	call   801037f0 <myproc>
...
80104964:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104967:	e8 84 ee ff ff       	call   801037f0 <myproc>
...
8010497c:	8b 14 85 00 79 10 80 	mov    -0x7fef8700(,%eax,4),%edx
...
801049a0:	68 c5 78 10 80       	push   $0x801078c5
...
801049d7:	89 4d bc             	mov    %ecx,-0x44(%ebp)
  if((dp = nameiparent(path, name)) == 0)
801049da:	e8 31 d5 ff ff       	call   80101f10 <nameiparent>
...
801049f0:	e8 9b cc ff ff       	call   80101690 <ilock>
...
801049fe:	e8 bd d1 ff ff       	call   80101bc0 <dirlookup>
80104a03:	83 c4 10             	add    $0x10,%esp
80104a06:	85 c0                	test   %eax,%eax
80104a08:	89 c7                	mov    %eax,%edi
80104a0a:	74 34                	je     80104a40 <create+0x80>
    iunlockput(dp);
80104a0c:	83 ec 0c             	sub    $0xc,%esp
80104a0f:	53                   	push   %ebx
80104a10:	e8 0b cf ff ff       	call   80101920 <iunlockput>
    ilock(ip);
80104a15:	89 3c 24             	mov    %edi,(%esp)
80104a18:	e8 73 cc ff ff       	call   80101690 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80104a1d:	83 c4 10             	add    $0x10,%esp
80104a20:	66 83 7d c4 02       	cmpw   $0x2,-0x3c(%ebp)
80104a25:	0f 85 95 00 00 00    	jne    80104ac0 <create+0x100>
80104a2b:	66 83 7f 50 02       	cmpw   $0x2,0x50(%edi)
80104a30:	0f 85 8a 00 00 00    	jne    80104ac0 <create+0x100>
...
80104a36:	8d 65 f4             	lea    -0xc(%ebp),%esp
80104a39:	89 f8                	mov    %edi,%eax
80104a3b:	5b                   	pop    %ebx
80104a3c:	5e                   	pop    %esi
80104a3d:	5f                   	pop    %edi
80104a3e:	5d                   	pop    %ebp
...
80104a4a:	e8 d1 ca ff ff       	call   80101520 <ialloc>
...
80104a81:	e8 5a cb ff ff       	call   801015e0 <iupdate>
...
80104a98:	e8 93 d3 ff ff       	call   80101e30 <dirlink>
...
80104aac:	e8 6f ce ff ff       	call   80101920 <iunlockput>
  return ip;
...
80104ac4:	31 ff                	xor    %edi,%edi
    iunlockput(ip);
80104ac6:	e8 55 ce ff ff       	call   80101920 <iunlockput>
    return 0;
...
80104ae9:	e8 f2 ca ff ff       	call   801015e0 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80104aee:	83 c4 0c             	add    $0xc,%esp
80104af1:	ff 77 04             	pushl  0x4(%edi)
80104af4:	68 78 79 10 80       	push   $0x80107978
80104af9:	57                   	push   %edi
80104afa:	e8 31 d3 ff ff       	call   80101e30 <dirlink>
...
80104b0c:	68 77 79 10 80       	push   $0x80107977
80104b11:	57                   	push   %edi
80104b12:	e8 19 d3 ff ff       	call   80101e30 <dirlink>
...
80104b84:	e8 67 ec ff ff       	call   801037f0 <myproc>
...
80104bc9:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104bcb:	e8 20 ec ff ff       	call   801037f0 <myproc>
...
80104d13:	78 2b                	js     80104d40 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104d15:	e8 d6 ea ff ff       	call   801037f0 <myproc>
...
80104dd2:	0f 88 e2 00 00 00    	js     80104eba <sys_link+0x11a>
  begin_op();
80104dd8:	e8 d3 dd ff ff       	call   80102bb0 <begin_op>
  if((ip = namei(old)) == 0){
80104ddd:	83 ec 0c             	sub    $0xc,%esp
80104de0:	ff 75 d4             	pushl  -0x2c(%ebp)
80104de3:	e8 08 d1 ff ff       	call   80101ef0 <namei>
...
80104df9:	e8 92 c8 ff ff       	call   80101690 <ilock>
  if(ip->type == T_DIR){
...
80104e18:	e8 c3 c7 ff ff       	call   801015e0 <iupdate>
  iunlock(ip);
80104e1d:	89 1c 24             	mov    %ebx,(%esp)
80104e20:	e8 4b c9 ff ff       	call   80101770 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80104e25:	58                   	pop    %eax
80104e26:	5a                   	pop    %edx
80104e27:	57                   	push   %edi
80104e28:	ff 75 d0             	pushl  -0x30(%ebp)
80104e2b:	e8 e0 d0 ff ff       	call   80101f10 <nameiparent>
...
80104e3d:	e8 4e c8 ff ff       	call   80101690 <ilock>
...
80104e53:	e8 d8 cf ff ff       	call   80101e30 <dirlink>
...
80104e63:	e8 b8 ca ff ff       	call   80101920 <iunlockput>
  iput(ip);
80104e68:	89 1c 24             	mov    %ebx,(%esp)
80104e6b:	e8 50 c9 ff ff       	call   801017c0 <iput>
  end_op();
...
80104e8c:	e8 8f ca ff ff       	call   80101920 <iunlockput>
    goto bad;
80104e91:	83 c4 10             	add    $0x10,%esp
  ilock(ip);
80104e94:	83 ec 0c             	sub    $0xc,%esp
80104e97:	53                   	push   %ebx
80104e98:	e8 f3 c7 ff ff       	call   80101690 <ilock>
  ip->nlink--;
80104e9d:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80104ea2:	89 1c 24             	mov    %ebx,(%esp)
80104ea5:	e8 36 c7 ff ff       	call   801015e0 <iupdate>
  iunlockput(ip);
80104eaa:	89 1c 24             	mov    %ebx,(%esp)
80104ead:	e8 6e ca ff ff       	call   80101920 <iunlockput>
  end_op();
80104eb2:	e8 69 dd ff ff       	call   80102c20 <end_op>
  return -1;
...
80104edd:	eb 9b                	jmp    80104e7a <sys_link+0xda>
    end_op();
80104edf:	e8 3c dd ff ff       	call   80102c20 <end_op>
    return -1;
...
80104f0f:	8d 5d ca             	lea    -0x36(%ebp),%ebx
  begin_op();
80104f12:	e8 99 dc ff ff       	call   80102bb0 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80104f17:	83 ec 08             	sub    $0x8,%esp
80104f1a:	53                   	push   %ebx
80104f1b:	ff 75 c0             	pushl  -0x40(%ebp)
80104f1e:	e8 ed cf ff ff       	call   80101f10 <nameiparent>
...
80104f34:	e8 57 c7 ff ff       	call   80101690 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80104f39:	58                   	pop    %eax
80104f3a:	5a                   	pop    %edx
80104f3b:	68 78 79 10 80       	push   $0x80107978
80104f40:	53                   	push   %ebx
80104f41:	e8 5a cc ff ff       	call   80101ba0 <namecmp>
...
80104f54:	68 77 79 10 80       	push   $0x80107977
80104f59:	53                   	push   %ebx
80104f5a:	e8 41 cc ff ff       	call   80101ba0 <namecmp>
...
80104f73:	e8 48 cc ff ff       	call   80101bc0 <dirlookup>
...
80104fbd:	e8 ae ca ff ff       	call   80101a70 <writei>
...
80104fea:	e8 f1 c5 ff ff       	call   801015e0 <iupdate>
  iunlockput(ip);
80104fef:	89 1c 24             	mov    %ebx,(%esp)
80104ff2:	e8 29 c9 ff ff       	call   80101920 <iunlockput>
  end_op();
80104ff7:	e8 24 dc ff ff       	call   80102c20 <end_op>
  return 0;
...
80105034:	e8 37 c9 ff ff       	call   80101970 <readi>
...
80105058:	e8 c3 c8 ff ff       	call   80101920 <iunlockput>
  end_op();
8010505d:	e8 be db ff ff       	call   80102c20 <end_op>
  return -1;
...
80105079:	e8 62 c5 ff ff       	call   801015e0 <iupdate>
...
80105102:	0f 88 04 01 00 00    	js     8010520c <sys_open+0x13c>
  ...
  begin_op();
80105108:	e8 a3 da ff ff       	call   80102bb0 <begin_op>
...
8010511d:	e8 ce cd ff ff       	call   80101ef0 <namei>
...
80105133:	e8 58 c5 ff ff       	call   80101690 <ilock>
...
8010514f:	0f 84 a6 00 00 00    	je     801051fb <sys_open+0x12b>
  struct proc *curproc = myproc();
80105155:	e8 96 e6 ff ff       	call   801037f0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
8010517c:	e8 ef c5 ff ff       	call   80101770 <iunlock>
  end_op();
...
801051db:	0f 85 65 ff ff ff    	jne    80105146 <sys_open+0x76>
      end_op();
801051e1:	e8 3a da ff ff       	call   80102c20 <end_op>
      return -1;
...
801052fe:	e8 1d c6 ff ff       	call   80101920 <iunlockput>
  end_op();
80105303:	e8 18 d9 ff ff       	call   80102c20 <end_op>
  return 0;
...
80105325:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105328:	e8 c3 e4 ff ff       	call   801037f0 <myproc>
8010532d:	89 c6                	mov    %eax,%esi
  
  begin_op();
8010532f:	e8 7c d8 ff ff       	call   80102bb0 <begin_op>
...
8010534f:	e8 9c cb ff ff       	call   80101ef0 <namei>
...
80105361:	e8 2a c3 ff ff       	call   80101690 <ilock>
  if(ip->type != T_DIR){
...
80105374:	e8 f7 c3 ff ff       	call   80101770 <iunlock>
  iput(curproc->cwd);
80105379:	58                   	pop    %eax
8010537a:	ff 76 68             	pushl  0x68(%esi)
8010537d:	e8 3e c4 ff ff       	call   801017c0 <iput>
  end_op();
80105382:	e8 99 d8 ff ff       	call   80102c20 <end_op>
  curproc->cwd = ip;
...
801053a4:	e8 77 c5 ff ff       	call   80101920 <iunlockput>
    end_op();
801053a9:	e8 72 d8 ff ff       	call   80102c20 <end_op>
    return -1;
...
801054ec:	e8 5f dd ff ff       	call   80103250 <pipealloc>
...
801054ff:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80105501:	e8 ea e2 ff ff       	call   801037f0 <myproc>
...
80105527:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
8010552a:	e8 c1 e2 ff ff       	call   801037f0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105561:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      myproc()->ofile[fd0] = 0;
80105568:	e8 83 e2 ff ff       	call   801037f0 <myproc>
...
801055a3:	5d                   	pop    %ebp
  return fork();
801055a4:	e9 e7 e3 ff ff       	jmp    80103990 <fork>
...
801055b3:	83 ec 08             	sub    $0x8,%esp
  exit();
801055b6:	e8 55 e6 ff ff       	call   80103c10 <exit>
...
801055c3:	5d                   	pop    %ebp
  return wait();
801055c4:	e9 87 e8 ff ff       	jmp    80103e50 <wait>
...
801055ee:	e8 ad e9 ff ff       	call   80103fa0 <kill>
...
80105613:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105616:	e8 d5 e1 ff ff       	call   801037f0 <myproc>
...
80105637:	78 27                	js     80105660 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
80105639:	e8 b2 e1 ff ff       	call   801037f0 <myproc>
  if(growproc(n) < 0)
...
80105646:	e8 c5 e2 ff ff       	call   80103910 <growproc>
...
80105690:	68 60 4c 18 80       	push   $0x80184c60
...
8010569d:	83 c4 10             	add    $0x10,%esp
  ticks0 = ticks;
801056a0:	8b 1d a0 54 18 80    	mov    0x801854a0,%ebx
  while(ticks - ticks0 < n){
...
801056b3:	68 60 4c 18 80       	push   $0x80184c60
801056b8:	68 a0 54 18 80       	push   $0x801854a0
801056bd:	e8 ce e6 ff ff       	call   80103d90 <sleep>
  while(ticks - ticks0 < n){
801056c2:	a1 a0 54 18 80       	mov    0x801854a0,%eax
...
801056e0:	68 60 4c 18 80       	push   $0x80184c60
...
80105703:	68 60 4c 18 80       	push   $0x80184c60
...
80105724:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105727:	68 60 4c 18 80       	push   $0x80184c60
8010572c:	e8 2f ed ff ff       	call   80104460 <acquire>
  xticks = ticks;
80105731:	8b 1d a0 54 18 80    	mov    0x801854a0,%ebx
  release(&tickslock);
80105737:	c7 04 24 60 4c 18 80 	movl   $0x80184c60,(%esp)
...
80105753:	5d                   	pop    %ebp
   procdump();
80105754:	e9 c7 e8 ff ff       	jmp    80104020 <procdump>
...
80105797:	c7 04 c5 a2 4c 18 80 	movl   $0x8e000008,-0x7fe7b35e(,%eax,8)
8010579e:	08 00 00 8e 
801057a2:	66 89 14 c5 a0 4c 18 	mov    %dx,-0x7fe7b360(,%eax,8)
801057a9:	80 
801057aa:	c1 ea 10             	shr    $0x10,%edx
801057ad:	66 89 14 c5 a6 4c 18 	mov    %dx,-0x7fe7b35a(,%eax,8)
801057b4:	80 
  for(i = 0; i < 256; i++)
...
801057c4:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801057c7:	c7 05 a2 4e 18 80 08 	movl   $0xef000008,0x80184ea2
801057ce:	00 00 ef 
  initlock(&tickslock, "time");
801057d1:	68 bd 79 10 80       	push   $0x801079bd
801057d6:	68 60 4c 18 80       	push   $0x80184c60
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801057db:	66 a3 a0 4e 18 80    	mov    %ax,0x80184ea0
801057e1:	c1 e8 10             	shr    $0x10,%eax
801057e4:	66 a3 a6 4e 18 80    	mov    %ax,0x80184ea6
  initlock(&tickslock, "time");
...
8010580b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010580f:	b8 a0 4c 18 80       	mov    $0x80184ca0,%eax
...
80105842:	0f 84 f0 00 00 00    	je     80105938 <trap+0x108>
  ...
  switch(tf->trapno){
80105848:	83 e8 0e             	sub    $0xe,%eax
8010584b:	83 f8 31             	cmp    $0x31,%eax
8010584e:	77 10                	ja     80105860 <trap+0x30>
80105850:	ff 24 85 64 7a 10 80 	jmp    *-0x7fef859c(,%eax,4)
...
80105867:	0f 84 07 02 00 00    	je     80105a74 <trap+0x244>
8010586d:	f6 47 3c 03          	testb  $0x3,0x3c(%edi)
80105871:	0f 84 fd 01 00 00    	je     80105a74 <trap+0x244>
...
80105883:	e8 48 df ff ff       	call   801037d0 <cpuid>
...
801058b5:	68 20 7a 10 80       	push   $0x80107a20
...
801058d7:	74 1d                	je     801058f6 <trap+0xc6>
801058d9:	e8 12 df ff ff       	call   801037f0 <myproc>
801058de:	8b 50 24             	mov    0x24(%eax),%edx
801058e1:	85 d2                	test   %edx,%edx
801058e3:	74 11                	je     801058f6 <trap+0xc6>
801058e5:	0f b7 47 3c          	movzwl 0x3c(%edi),%eax
801058e9:	83 e0 03             	and    $0x3,%eax
801058ec:	66 83 f8 03          	cmp    $0x3,%ax
801058f0:	0f 84 3a 01 00 00    	je     80105a30 <trap+0x200>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
801058f6:	e8 f5 de ff ff       	call   801037f0 <myproc>
801058fb:	85 c0                	test   %eax,%eax
801058fd:	74 0b                	je     8010590a <trap+0xda>
801058ff:	e8 ec de ff ff       	call   801037f0 <myproc>
80105904:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80105908:	74 66                	je     80105970 <trap+0x140>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
8010590a:	e8 e1 de ff ff       	call   801037f0 <myproc>
8010590f:	85 c0                	test   %eax,%eax
80105911:	74 19                	je     8010592c <trap+0xfc>
80105913:	e8 d8 de ff ff       	call   801037f0 <myproc>
80105918:	8b 40 24             	mov    0x24(%eax),%eax
8010591b:	85 c0                	test   %eax,%eax
8010591d:	74 0d                	je     8010592c <trap+0xfc>
8010591f:	0f b7 47 3c          	movzwl 0x3c(%edi),%eax
80105923:	83 e0 03             	and    $0x3,%eax
80105926:	66 83 f8 03          	cmp    $0x3,%ax
8010592a:	74 35                	je     80105961 <trap+0x131>
    exit();
}
...
80105942:	0f 85 d8 00 00 00    	jne    80105a20 <trap+0x1f0>
    myproc()->tf = tf;
...
8010595f:	74 cb                	je     8010592c <trap+0xfc>
}
...
80105967:	5d                   	pop    %ebp
      exit();
80105968:	e9 a3 e2 ff ff       	jmp    80103c10 <exit>
8010596d:	8d 76 00             	lea    0x0(%esi),%esi
  if(myproc() && myproc()->state == RUNNING &&
80105970:	83 7f 30 20          	cmpl   $0x20,0x30(%edi)
80105974:	75 94                	jne    8010590a <trap+0xda>
    yield();
80105976:	e8 c5 e3 ff ff       	call   80103d40 <yield>
8010597b:	eb 8d                	jmp    8010590a <trap+0xda>
8010597d:	8d 76 00             	lea    0x0(%esi),%esi
    myproc()->tf = tf;
80105980:	e8 6b de ff ff       	call   801037f0 <myproc>
80105985:	89 78 18             	mov    %edi,0x18(%eax)
    handle_pgflt();
80105988:	e8 c3 14 00 00       	call   80106e50 <handle_pgflt>
    break;
8010598d:	e9 3e ff ff ff       	jmp    801058d0 <trap+0xa0>
80105992:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(cpuid() == 0){
80105998:	e8 33 de ff ff       	call   801037d0 <cpuid>
8010599d:	85 c0                	test   %eax,%eax
8010599f:	0f 84 9b 00 00 00    	je     80105a40 <trap+0x210>
    lapiceoi();
801059a5:	e8 b6 cd ff ff       	call   80102760 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801059aa:	e8 41 de ff ff       	call   801037f0 <myproc>
801059af:	85 c0                	test   %eax,%eax
801059b1:	0f 85 22 ff ff ff    	jne    801058d9 <trap+0xa9>
801059b7:	e9 3a ff ff ff       	jmp    801058f6 <trap+0xc6>
801059bc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
801059c0:	e8 5b cc ff ff       	call   80102620 <kbdintr>
    lapiceoi();
801059c5:	e8 96 cd ff ff       	call   80102760 <lapiceoi>
    break;
801059ca:	e9 01 ff ff ff       	jmp    801058d0 <trap+0xa0>
801059cf:	90                   	nop
    uartintr();
801059d0:	e8 3b 02 00 00       	call   80105c10 <uartintr>
    lapiceoi();
801059d5:	e8 86 cd ff ff       	call   80102760 <lapiceoi>
    break;
801059da:	e9 f1 fe ff ff       	jmp    801058d0 <trap+0xa0>
801059df:	90                   	nop
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
801059e0:	0f b7 5f 3c          	movzwl 0x3c(%edi),%ebx
801059e4:	8b 77 38             	mov    0x38(%edi),%esi
801059e7:	e8 e4 dd ff ff       	call   801037d0 <cpuid>
801059ec:	56                   	push   %esi
801059ed:	53                   	push   %ebx
801059ee:	50                   	push   %eax
801059ef:	68 c8 79 10 80       	push   $0x801079c8
801059f4:	e8 67 ac ff ff       	call   80100660 <cprintf>
    lapiceoi();
801059f9:	e8 62 cd ff ff       	call   80102760 <lapiceoi>
    break;
801059fe:	83 c4 10             	add    $0x10,%esp
80105a01:	e9 ca fe ff ff       	jmp    801058d0 <trap+0xa0>
...
80105a15:	eb 8e                	jmp    801059a5 <trap+0x175>
80105a17:	89 f6                	mov    %esi,%esi
80105a19:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
      exit();
80105a20:	e8 eb e1 ff ff       	call   80103c10 <exit>
80105a25:	e9 1e ff ff ff       	jmp    80105948 <trap+0x118>
80105a2a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    exit();
80105a30:	e8 db e1 ff ff       	call   80103c10 <exit>
80105a35:	e9 bc fe ff ff       	jmp    801058f6 <trap+0xc6>
80105a3a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      acquire(&tickslock);
80105a40:	83 ec 0c             	sub    $0xc,%esp
80105a43:	68 60 4c 18 80       	push   $0x80184c60
80105a48:	e8 13 ea ff ff       	call   80104460 <acquire>
      wakeup(&ticks);
80105a4d:	c7 04 24 a0 54 18 80 	movl   $0x801854a0,(%esp)
      ticks++;
80105a54:	83 05 a0 54 18 80 01 	addl   $0x1,0x801854a0
      wakeup(&ticks);
80105a5b:	e8 e0 e4 ff ff       	call   80103f40 <wakeup>
      release(&tickslock);
80105a60:	c7 04 24 60 4c 18 80 	movl   $0x80184c60,(%esp)
80105a67:	e8 b4 ea ff ff       	call   80104520 <release>
80105a6c:	83 c4 10             	add    $0x10,%esp
80105a6f:	e9 31 ff ff ff       	jmp    801059a5 <trap+0x175>
80105a74:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105a77:	8b 5f 38             	mov    0x38(%edi),%ebx
80105a7a:	e8 51 dd ff ff       	call   801037d0 <cpuid>
...
80105a88:	68 ec 79 10 80       	push   $0x801079ec
80105a8d:	e8 ce ab ff ff       	call   80100660 <cprintf>
      panic("trap");
80105a92:	83 c4 14             	add    $0x14,%esp
80105a95:	68 c2 79 10 80       	push   $0x801079c2
...
80105b8c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105b8f:	bb 2c 7b 10 80       	mov    $0x80107b2c,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80105c27:	6a 00                	push   $0x0
  jmp alltraps
80105c29:	e9 2b fb ff ff       	jmp    80105759 <alltraps>
...
80105c30:	6a 01                	push   $0x1
  jmp alltraps
80105c32:	e9 22 fb ff ff       	jmp    80105759 <alltraps>
...
80105c39:	6a 02                	push   $0x2
  jmp alltraps
80105c3b:	e9 19 fb ff ff       	jmp    80105759 <alltraps>
...
80105c42:	6a 03                	push   $0x3
  jmp alltraps
80105c44:	e9 10 fb ff ff       	jmp    80105759 <alltraps>
...
80105c4b:	6a 04                	push   $0x4
  jmp alltraps
80105c4d:	e9 07 fb ff ff       	jmp    80105759 <alltraps>
...
80105c54:	6a 05                	push   $0x5
  jmp alltraps
80105c56:	e9 fe fa ff ff       	jmp    80105759 <alltraps>
...
80105c5d:	6a 06                	push   $0x6
  jmp alltraps
80105c5f:	e9 f5 fa ff ff       	jmp    80105759 <alltraps>
...
80105c66:	6a 07                	push   $0x7
  jmp alltraps
80105c68:	e9 ec fa ff ff       	jmp    80105759 <alltraps>
...
80105c84:	6a 0b                	push   $0xb
  jmp alltraps
80105c86:	e9 ce fa ff ff       	jmp    80105759 <alltraps>
...
80105c8b:	6a 0c                	push   $0xc
  jmp alltraps
80105c8d:	e9 c7 fa ff ff       	jmp    80105759 <alltraps>
...
80105c92:	6a 0d                	push   $0xd
  jmp alltraps
80105c94:	e9 c0 fa ff ff       	jmp    80105759 <alltraps>
...
80105c99:	6a 0e                	push   $0xe
  jmp alltraps
80105c9b:	e9 b9 fa ff ff       	jmp    80105759 <alltraps>
...
80105cab:	6a 10                	push   $0x10
  jmp alltraps
80105cad:	e9 a7 fa ff ff       	jmp    80105759 <alltraps>
...
80105cc4:	6a 13                	push   $0x13
  jmp alltraps
80105cc6:	e9 8e fa ff ff       	jmp    80105759 <alltraps>
...
80105ccd:	6a 14                	push   $0x14
  jmp alltraps
80105ccf:	e9 85 fa ff ff       	jmp    80105759 <alltraps>
...
80105cd6:	6a 15                	push   $0x15
  jmp alltraps
80105cd8:	e9 7c fa ff ff       	jmp    80105759 <alltraps>
...
80105cdf:	6a 16                	push   $0x16
  jmp alltraps
80105ce1:	e9 73 fa ff ff       	jmp    80105759 <alltraps>
...
80105ce8:	6a 17                	push   $0x17
  jmp alltraps
80105cea:	e9 6a fa ff ff       	jmp    80105759 <alltraps>
...
80105cf1:	6a 18                	push   $0x18
  jmp alltraps
80105cf3:	e9 61 fa ff ff       	jmp    80105759 <alltraps>
...
80105cfa:	6a 19                	push   $0x19
  jmp alltraps
80105cfc:	e9 58 fa ff ff       	jmp    80105759 <alltraps>
...
80105d03:	6a 1a                	push   $0x1a
  jmp alltraps
80105d05:	e9 4f fa ff ff       	jmp    80105759 <alltraps>
...
80105d0c:	6a 1b                	push   $0x1b
  jmp alltraps
80105d0e:	e9 46 fa ff ff       	jmp    80105759 <alltraps>
...
80105d15:	6a 1c                	push   $0x1c
  jmp alltraps
80105d17:	e9 3d fa ff ff       	jmp    80105759 <alltraps>
...
80105d1e:	6a 1d                	push   $0x1d
  jmp alltraps
80105d20:	e9 34 fa ff ff       	jmp    80105759 <alltraps>
...
80105d27:	6a 1e                	push   $0x1e
  jmp alltraps
80105d29:	e9 2b fa ff ff       	jmp    80105759 <alltraps>
...
80105d30:	6a 1f                	push   $0x1f
  jmp alltraps
80105d32:	e9 22 fa ff ff       	jmp    80105759 <alltraps>
...
80105d39:	6a 20                	push   $0x20
  jmp alltraps
80105d3b:	e9 19 fa ff ff       	jmp    80105759 <alltraps>
...
80105d42:	6a 21                	push   $0x21
  jmp alltraps
80105d44:	e9 10 fa ff ff       	jmp    80105759 <alltraps>
...
80105d4b:	6a 22                	push   $0x22
  jmp alltraps
80105d4d:	e9 07 fa ff ff       	jmp    80105759 <alltraps>
...
80105d54:	6a 23                	push   $0x23
  jmp alltraps
80105d56:	e9 fe f9 ff ff       	jmp    80105759 <alltraps>
...
80105d5d:	6a 24                	push   $0x24
  jmp alltraps
80105d5f:	e9 f5 f9 ff ff       	jmp    80105759 <alltraps>
...
80105d66:	6a 25                	push   $0x25
  jmp alltraps
80105d68:	e9 ec f9 ff ff       	jmp    80105759 <alltraps>
...
80105d6f:	6a 26                	push   $0x26
  jmp alltraps
80105d71:	e9 e3 f9 ff ff       	jmp    80105759 <alltraps>
...
80105d78:	6a 27                	push   $0x27
  jmp alltraps
80105d7a:	e9 da f9 ff ff       	jmp    80105759 <alltraps>
...
80105d81:	6a 28                	push   $0x28
  jmp alltraps
80105d83:	e9 d1 f9 ff ff       	jmp    80105759 <alltraps>
...
80105d8a:	6a 29                	push   $0x29
  jmp alltraps
80105d8c:	e9 c8 f9 ff ff       	jmp    80105759 <alltraps>
...
80105d93:	6a 2a                	push   $0x2a
  jmp alltraps
80105d95:	e9 bf f9 ff ff       	jmp    80105759 <alltraps>
...
80105d9c:	6a 2b                	push   $0x2b
  jmp alltraps
80105d9e:	e9 b6 f9 ff ff       	jmp    80105759 <alltraps>
...
80105da5:	6a 2c                	push   $0x2c
  jmp alltraps
80105da7:	e9 ad f9 ff ff       	jmp    80105759 <alltraps>
...
80105dae:	6a 2d                	push   $0x2d
  jmp alltraps
80105db0:	e9 a4 f9 ff ff       	jmp    80105759 <alltraps>
...
80105db7:	6a 2e                	push   $0x2e
  jmp alltraps
80105db9:	e9 9b f9 ff ff       	jmp    80105759 <alltraps>
...
80105dc0:	6a 2f                	push   $0x2f
  jmp alltraps
80105dc2:	e9 92 f9 ff ff       	jmp    80105759 <alltraps>
...
80105dc9:	6a 30                	push   $0x30
  jmp alltraps
80105dcb:	e9 89 f9 ff ff       	jmp    80105759 <alltraps>
...
80105dd2:	6a 31                	push   $0x31
  jmp alltraps
80105dd4:	e9 80 f9 ff ff       	jmp    80105759 <alltraps>
...
80105ddb:	6a 32                	push   $0x32
  jmp alltraps
80105ddd:	e9 77 f9 ff ff       	jmp    80105759 <alltraps>
...
80105de4:	6a 33                	push   $0x33
  jmp alltraps
80105de6:	e9 6e f9 ff ff       	jmp    80105759 <alltraps>
...
80105ded:	6a 34                	push   $0x34
  jmp alltraps
80105def:	e9 65 f9 ff ff       	jmp    80105759 <alltraps>
...
80105df6:	6a 35                	push   $0x35
  jmp alltraps
80105df8:	e9 5c f9 ff ff       	jmp    80105759 <alltraps>
...
80105dff:	6a 36                	push   $0x36
  jmp alltraps
80105e01:	e9 53 f9 ff ff       	jmp    80105759 <alltraps>
...
80105e08:	6a 37                	push   $0x37
  jmp alltraps
80105e0a:	e9 4a f9 ff ff       	jmp    80105759 <alltraps>
...
80105e11:	6a 38                	push   $0x38
  jmp alltraps
80105e13:	e9 41 f9 ff ff       	jmp    80105759 <alltraps>
...
80105e1a:	6a 39                	push   $0x39
  jmp alltraps
80105e1c:	e9 38 f9 ff ff       	jmp    80105759 <alltraps>
...
80105e23:	6a 3a                	push   $0x3a
  jmp alltraps
80105e25:	e9 2f f9 ff ff       	jmp    80105759 <alltraps>
...
80105e2c:	6a 3b                	push   $0x3b
  jmp alltraps
80105e2e:	e9 26 f9 ff ff       	jmp    80105759 <alltraps>
...
80105e35:	6a 3c                	push   $0x3c
  jmp alltraps
80105e37:	e9 1d f9 ff ff       	jmp    80105759 <alltraps>
...
80105e3e:	6a 3d                	push   $0x3d
  jmp alltraps
80105e40:	e9 14 f9 ff ff       	jmp    80105759 <alltraps>
...
80105e47:	6a 3e                	push   $0x3e
  jmp alltraps
80105e49:	e9 0b f9 ff ff       	jmp    80105759 <alltraps>
...
80105e50:	6a 3f                	push   $0x3f
  jmp alltraps
80105e52:	e9 02 f9 ff ff       	jmp    80105759 <alltraps>
...
80105e59:	6a 40                	push   $0x40
  jmp alltraps
80105e5b:	e9 f9 f8 ff ff       	jmp    80105759 <alltraps>
...
80105e62:	6a 41                	push   $0x41
  jmp alltraps
80105e64:	e9 f0 f8 ff ff       	jmp    80105759 <alltraps>
...
80105e6b:	6a 42                	push   $0x42
  jmp alltraps
80105e6d:	e9 e7 f8 ff ff       	jmp    80105759 <alltraps>
...
80105e74:	6a 43                	push   $0x43
  jmp alltraps
80105e76:	e9 de f8 ff ff       	jmp    80105759 <alltraps>
...
80105e7d:	6a 44                	push   $0x44
  jmp alltraps
80105e7f:	e9 d5 f8 ff ff       	jmp    80105759 <alltraps>
...
80105e86:	6a 45                	push   $0x45
  jmp alltraps
80105e88:	e9 cc f8 ff ff       	jmp    80105759 <alltraps>
...
80105e8f:	6a 46                	push   $0x46
  jmp alltraps
80105e91:	e9 c3 f8 ff ff       	jmp    80105759 <alltraps>
...
80105e98:	6a 47                	push   $0x47
  jmp alltraps
80105e9a:	e9 ba f8 ff ff       	jmp    80105759 <alltraps>
...
80105ea1:	6a 48                	push   $0x48
  jmp alltraps
80105ea3:	e9 b1 f8 ff ff       	jmp    80105759 <alltraps>
...
80105eaa:	6a 49                	push   $0x49
  jmp alltraps
80105eac:	e9 a8 f8 ff ff       	jmp    80105759 <alltraps>
...
80105eb3:	6a 4a                	push   $0x4a
  jmp alltraps
80105eb5:	e9 9f f8 ff ff       	jmp    80105759 <alltraps>
...
80105ebc:	6a 4b                	push   $0x4b
  jmp alltraps
80105ebe:	e9 96 f8 ff ff       	jmp    80105759 <alltraps>
...
80105ec5:	6a 4c                	push   $0x4c
  jmp alltraps
80105ec7:	e9 8d f8 ff ff       	jmp    80105759 <alltraps>
...
80105ece:	6a 4d                	push   $0x4d
  jmp alltraps
80105ed0:	e9 84 f8 ff ff       	jmp    80105759 <alltraps>
...
80105ed7:	6a 4e                	push   $0x4e
  jmp alltraps
80105ed9:	e9 7b f8 ff ff       	jmp    80105759 <alltraps>
...
80105ee0:	6a 4f                	push   $0x4f
  jmp alltraps
80105ee2:	e9 72 f8 ff ff       	jmp    80105759 <alltraps>
...
80105ee9:	6a 50                	push   $0x50
  jmp alltraps
80105eeb:	e9 69 f8 ff ff       	jmp    80105759 <alltraps>
...
80105ef2:	6a 51                	push   $0x51
  jmp alltraps
80105ef4:	e9 60 f8 ff ff       	jmp    80105759 <alltraps>
...
80105efb:	6a 52                	push   $0x52
  jmp alltraps
80105efd:	e9 57 f8 ff ff       	jmp    80105759 <alltraps>
...
80105f04:	6a 53                	push   $0x53
  jmp alltraps
80105f06:	e9 4e f8 ff ff       	jmp    80105759 <alltraps>
...
80105f0d:	6a 54                	push   $0x54
  jmp alltraps
80105f0f:	e9 45 f8 ff ff       	jmp    80105759 <alltraps>
...
80105f16:	6a 55                	push   $0x55
  jmp alltraps
80105f18:	e9 3c f8 ff ff       	jmp    80105759 <alltraps>
...
80105f1f:	6a 56                	push   $0x56
  jmp alltraps
80105f21:	e9 33 f8 ff ff       	jmp    80105759 <alltraps>
...
80105f28:	6a 57                	push   $0x57
  jmp alltraps
80105f2a:	e9 2a f8 ff ff       	jmp    80105759 <alltraps>
...
80105f31:	6a 58                	push   $0x58
  jmp alltraps
80105f33:	e9 21 f8 ff ff       	jmp    80105759 <alltraps>
...
80105f3a:	6a 59                	push   $0x59
  jmp alltraps
80105f3c:	e9 18 f8 ff ff       	jmp    80105759 <alltraps>
...
80105f43:	6a 5a                	push   $0x5a
  jmp alltraps
80105f45:	e9 0f f8 ff ff       	jmp    80105759 <alltraps>
...
80105f4c:	6a 5b                	push   $0x5b
  jmp alltraps
80105f4e:	e9 06 f8 ff ff       	jmp    80105759 <alltraps>
...
80105f55:	6a 5c                	push   $0x5c
  jmp alltraps
80105f57:	e9 fd f7 ff ff       	jmp    80105759 <alltraps>
...
80105f5e:	6a 5d                	push   $0x5d
  jmp alltraps
80105f60:	e9 f4 f7 ff ff       	jmp    80105759 <alltraps>
...
80105f67:	6a 5e                	push   $0x5e
  jmp alltraps
80105f69:	e9 eb f7 ff ff       	jmp    80105759 <alltraps>
...
80105f70:	6a 5f                	push   $0x5f
  jmp alltraps
80105f72:	e9 e2 f7 ff ff       	jmp    80105759 <alltraps>
...
80105f79:	6a 60                	push   $0x60
  jmp alltraps
80105f7b:	e9 d9 f7 ff ff       	jmp    80105759 <alltraps>
...
80105f82:	6a 61                	push   $0x61
  jmp alltraps
80105f84:	e9 d0 f7 ff ff       	jmp    80105759 <alltraps>
...
80105f8b:	6a 62                	push   $0x62
  jmp alltraps
80105f8d:	e9 c7 f7 ff ff       	jmp    80105759 <alltraps>
...
80105f94:	6a 63                	push   $0x63
  jmp alltraps
80105f96:	e9 be f7 ff ff       	jmp    80105759 <alltraps>
...
80105f9d:	6a 64                	push   $0x64
  jmp alltraps
80105f9f:	e9 b5 f7 ff ff       	jmp    80105759 <alltraps>
...
80105fa6:	6a 65                	push   $0x65
  jmp alltraps
80105fa8:	e9 ac f7 ff ff       	jmp    80105759 <alltraps>
...
80105faf:	6a 66                	push   $0x66
  jmp alltraps
80105fb1:	e9 a3 f7 ff ff       	jmp    80105759 <alltraps>
...
80105fb8:	6a 67                	push   $0x67
  jmp alltraps
80105fba:	e9 9a f7 ff ff       	jmp    80105759 <alltraps>
...
80105fc1:	6a 68                	push   $0x68
  jmp alltraps
80105fc3:	e9 91 f7 ff ff       	jmp    80105759 <alltraps>
...
80105fca:	6a 69                	push   $0x69
  jmp alltraps
80105fcc:	e9 88 f7 ff ff       	jmp    80105759 <alltraps>
...
80105fd3:	6a 6a                	push   $0x6a
  jmp alltraps
80105fd5:	e9 7f f7 ff ff       	jmp    80105759 <alltraps>
...
80105fdc:	6a 6b                	push   $0x6b
  jmp alltraps
80105fde:	e9 76 f7 ff ff       	jmp    80105759 <alltraps>
...
80105fe5:	6a 6c                	push   $0x6c
  jmp alltraps
80105fe7:	e9 6d f7 ff ff       	jmp    80105759 <alltraps>
...
80105fee:	6a 6d                	push   $0x6d
  jmp alltraps
80105ff0:	e9 64 f7 ff ff       	jmp    80105759 <alltraps>
...
80105ff7:	6a 6e                	push   $0x6e
  jmp alltraps
80105ff9:	e9 5b f7 ff ff       	jmp    80105759 <alltraps>
...
80106000:	6a 6f                	push   $0x6f
  jmp alltraps
80106002:	e9 52 f7 ff ff       	jmp    80105759 <alltraps>
...
80106009:	6a 70                	push   $0x70
  jmp alltraps
8010600b:	e9 49 f7 ff ff       	jmp    80105759 <alltraps>
...
80106012:	6a 71                	push   $0x71
  jmp alltraps
80106014:	e9 40 f7 ff ff       	jmp    80105759 <alltraps>
...
8010601b:	6a 72                	push   $0x72
  jmp alltraps
8010601d:	e9 37 f7 ff ff       	jmp    80105759 <alltraps>
...
80106024:	6a 73                	push   $0x73
  jmp alltraps
80106026:	e9 2e f7 ff ff       	jmp    80105759 <alltraps>
...
8010602d:	6a 74                	push   $0x74
  jmp alltraps
8010602f:	e9 25 f7 ff ff       	jmp    80105759 <alltraps>
...
80106036:	6a 75                	push   $0x75
  jmp alltraps
80106038:	e9 1c f7 ff ff       	jmp    80105759 <alltraps>
...
8010603f:	6a 76                	push   $0x76
  jmp alltraps
80106041:	e9 13 f7 ff ff       	jmp    80105759 <alltraps>
...
80106048:	6a 77                	push   $0x77
  jmp alltraps
8010604a:	e9 0a f7 ff ff       	jmp    80105759 <alltraps>
...
80106051:	6a 78                	push   $0x78
  jmp alltraps
80106053:	e9 01 f7 ff ff       	jmp    80105759 <alltraps>
...
8010605a:	6a 79                	push   $0x79
  jmp alltraps
8010605c:	e9 f8 f6 ff ff       	jmp    80105759 <alltraps>
...
80106063:	6a 7a                	push   $0x7a
  jmp alltraps
80106065:	e9 ef f6 ff ff       	jmp    80105759 <alltraps>
...
8010606c:	6a 7b                	push   $0x7b
  jmp alltraps
8010606e:	e9 e6 f6 ff ff       	jmp    80105759 <alltraps>
...
80106075:	6a 7c                	push   $0x7c
  jmp alltraps
80106077:	e9 dd f6 ff ff       	jmp    80105759 <alltraps>
...
8010607e:	6a 7d                	push   $0x7d
  jmp alltraps
80106080:	e9 d4 f6 ff ff       	jmp    80105759 <alltraps>
...
80106087:	6a 7e                	push   $0x7e
  jmp alltraps
80106089:	e9 cb f6 ff ff       	jmp    80105759 <alltraps>
...
80106090:	6a 7f                	push   $0x7f
  jmp alltraps
80106092:	e9 c2 f6 ff ff       	jmp    80105759 <alltraps>
...
80106099:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010609e:	e9 b6 f6 ff ff       	jmp    80105759 <alltraps>
...
801060a5:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801060aa:	e9 aa f6 ff ff       	jmp    80105759 <alltraps>
...
801060b1:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801060b6:	e9 9e f6 ff ff       	jmp    80105759 <alltraps>
...
801060bd:	68 83 00 00 00       	push   $0x83
  jmp alltraps
801060c2:	e9 92 f6 ff ff       	jmp    80105759 <alltraps>
...
801060c9:	68 84 00 00 00       	push   $0x84
  jmp alltraps
801060ce:	e9 86 f6 ff ff       	jmp    80105759 <alltraps>
...
801060d5:	68 85 00 00 00       	push   $0x85
  jmp alltraps
801060da:	e9 7a f6 ff ff       	jmp    80105759 <alltraps>
...
801060e1:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801060e6:	e9 6e f6 ff ff       	jmp    80105759 <alltraps>
...
801060ed:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801060f2:	e9 62 f6 ff ff       	jmp    80105759 <alltraps>
...
801060f9:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801060fe:	e9 56 f6 ff ff       	jmp    80105759 <alltraps>
...
80106105:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010610a:	e9 4a f6 ff ff       	jmp    80105759 <alltraps>
...
80106111:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106116:	e9 3e f6 ff ff       	jmp    80105759 <alltraps>
...
8010611d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106122:	e9 32 f6 ff ff       	jmp    80105759 <alltraps>
...
80106129:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010612e:	e9 26 f6 ff ff       	jmp    80105759 <alltraps>
...
80106135:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010613a:	e9 1a f6 ff ff       	jmp    80105759 <alltraps>
...
80106141:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106146:	e9 0e f6 ff ff       	jmp    80105759 <alltraps>
...
8010614d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106152:	e9 02 f6 ff ff       	jmp    80105759 <alltraps>
...
80106159:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010615e:	e9 f6 f5 ff ff       	jmp    80105759 <alltraps>
...
80106165:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010616a:	e9 ea f5 ff ff       	jmp    80105759 <alltraps>
...
80106171:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106176:	e9 de f5 ff ff       	jmp    80105759 <alltraps>
...
8010617d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106182:	e9 d2 f5 ff ff       	jmp    80105759 <alltraps>
...
80106189:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010618e:	e9 c6 f5 ff ff       	jmp    80105759 <alltraps>
...
80106195:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010619a:	e9 ba f5 ff ff       	jmp    80105759 <alltraps>
...
801061a1:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801061a6:	e9 ae f5 ff ff       	jmp    80105759 <alltraps>
...
801061ad:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801061b2:	e9 a2 f5 ff ff       	jmp    80105759 <alltraps>
...
801061b9:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801061be:	e9 96 f5 ff ff       	jmp    80105759 <alltraps>
...
801061c5:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801061ca:	e9 8a f5 ff ff       	jmp    80105759 <alltraps>
...
801061d1:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801061d6:	e9 7e f5 ff ff       	jmp    80105759 <alltraps>
...
801061dd:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801061e2:	e9 72 f5 ff ff       	jmp    80105759 <alltraps>
...
801061e9:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801061ee:	e9 66 f5 ff ff       	jmp    80105759 <alltraps>
...
801061f5:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801061fa:	e9 5a f5 ff ff       	jmp    80105759 <alltraps>
...
80106201:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106206:	e9 4e f5 ff ff       	jmp    80105759 <alltraps>
...
8010620d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106212:	e9 42 f5 ff ff       	jmp    80105759 <alltraps>
...
80106219:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010621e:	e9 36 f5 ff ff       	jmp    80105759 <alltraps>
...
80106225:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010622a:	e9 2a f5 ff ff       	jmp    80105759 <alltraps>
...
80106231:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106236:	e9 1e f5 ff ff       	jmp    80105759 <alltraps>
...
8010623d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106242:	e9 12 f5 ff ff       	jmp    80105759 <alltraps>
...
80106249:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010624e:	e9 06 f5 ff ff       	jmp    80105759 <alltraps>
...
80106255:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010625a:	e9 fa f4 ff ff       	jmp    80105759 <alltraps>
...
80106261:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106266:	e9 ee f4 ff ff       	jmp    80105759 <alltraps>
...
8010626d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106272:	e9 e2 f4 ff ff       	jmp    80105759 <alltraps>
...
80106279:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010627e:	e9 d6 f4 ff ff       	jmp    80105759 <alltraps>
...
80106285:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010628a:	e9 ca f4 ff ff       	jmp    80105759 <alltraps>
...
80106291:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106296:	e9 be f4 ff ff       	jmp    80105759 <alltraps>
...
8010629d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801062a2:	e9 b2 f4 ff ff       	jmp    80105759 <alltraps>
...
801062a9:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801062ae:	e9 a6 f4 ff ff       	jmp    80105759 <alltraps>
...
801062b5:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801062ba:	e9 9a f4 ff ff       	jmp    80105759 <alltraps>
...
801062c1:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801062c6:	e9 8e f4 ff ff       	jmp    80105759 <alltraps>
...
801062cd:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801062d2:	e9 82 f4 ff ff       	jmp    80105759 <alltraps>
...
801062d9:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801062de:	e9 76 f4 ff ff       	jmp    80105759 <alltraps>
...
801062e5:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801062ea:	e9 6a f4 ff ff       	jmp    80105759 <alltraps>
...
801062f1:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801062f6:	e9 5e f4 ff ff       	jmp    80105759 <alltraps>
...
801062fd:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106302:	e9 52 f4 ff ff       	jmp    80105759 <alltraps>
...
80106309:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010630e:	e9 46 f4 ff ff       	jmp    80105759 <alltraps>
...
80106315:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010631a:	e9 3a f4 ff ff       	jmp    80105759 <alltraps>
...
80106321:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106326:	e9 2e f4 ff ff       	jmp    80105759 <alltraps>
...
8010632d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106332:	e9 22 f4 ff ff       	jmp    80105759 <alltraps>
...
80106339:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010633e:	e9 16 f4 ff ff       	jmp    80105759 <alltraps>
...
80106345:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010634a:	e9 0a f4 ff ff       	jmp    80105759 <alltraps>
...
80106351:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106356:	e9 fe f3 ff ff       	jmp    80105759 <alltraps>
...
8010635d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106362:	e9 f2 f3 ff ff       	jmp    80105759 <alltraps>
...
80106369:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010636e:	e9 e6 f3 ff ff       	jmp    80105759 <alltraps>
...
80106375:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010637a:	e9 da f3 ff ff       	jmp    80105759 <alltraps>
...
80106381:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106386:	e9 ce f3 ff ff       	jmp    80105759 <alltraps>
...
8010638d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106392:	e9 c2 f3 ff ff       	jmp    80105759 <alltraps>
...
80106399:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010639e:	e9 b6 f3 ff ff       	jmp    80105759 <alltraps>
...
801063a5:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801063aa:	e9 aa f3 ff ff       	jmp    80105759 <alltraps>
...
801063b1:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801063b6:	e9 9e f3 ff ff       	jmp    80105759 <alltraps>
...
801063bd:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801063c2:	e9 92 f3 ff ff       	jmp    80105759 <alltraps>
...
801063c9:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801063ce:	e9 86 f3 ff ff       	jmp    80105759 <alltraps>
...
801063d5:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801063da:	e9 7a f3 ff ff       	jmp    80105759 <alltraps>
...
801063e1:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801063e6:	e9 6e f3 ff ff       	jmp    80105759 <alltraps>
...
801063ed:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801063f2:	e9 62 f3 ff ff       	jmp    80105759 <alltraps>
...
801063f9:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801063fe:	e9 56 f3 ff ff       	jmp    80105759 <alltraps>
...
80106405:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010640a:	e9 4a f3 ff ff       	jmp    80105759 <alltraps>
...
80106411:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106416:	e9 3e f3 ff ff       	jmp    80105759 <alltraps>
...
8010641d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106422:	e9 32 f3 ff ff       	jmp    80105759 <alltraps>
...
80106429:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010642e:	e9 26 f3 ff ff       	jmp    80105759 <alltraps>
...
80106435:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010643a:	e9 1a f3 ff ff       	jmp    80105759 <alltraps>
...
80106441:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106446:	e9 0e f3 ff ff       	jmp    80105759 <alltraps>
...
8010644d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106452:	e9 02 f3 ff ff       	jmp    80105759 <alltraps>
...
80106459:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010645e:	e9 f6 f2 ff ff       	jmp    80105759 <alltraps>
...
80106465:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010646a:	e9 ea f2 ff ff       	jmp    80105759 <alltraps>
...
80106471:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106476:	e9 de f2 ff ff       	jmp    80105759 <alltraps>
...
8010647d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106482:	e9 d2 f2 ff ff       	jmp    80105759 <alltraps>
...
80106489:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010648e:	e9 c6 f2 ff ff       	jmp    80105759 <alltraps>
...
80106495:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010649a:	e9 ba f2 ff ff       	jmp    80105759 <alltraps>
...
801064a1:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801064a6:	e9 ae f2 ff ff       	jmp    80105759 <alltraps>
...
801064ad:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801064b2:	e9 a2 f2 ff ff       	jmp    80105759 <alltraps>
...
801064b9:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801064be:	e9 96 f2 ff ff       	jmp    80105759 <alltraps>
...
801064c5:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801064ca:	e9 8a f2 ff ff       	jmp    80105759 <alltraps>
...
801064d1:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801064d6:	e9 7e f2 ff ff       	jmp    80105759 <alltraps>
...
801064dd:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801064e2:	e9 72 f2 ff ff       	jmp    80105759 <alltraps>
...
801064e9:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
801064ee:	e9 66 f2 ff ff       	jmp    80105759 <alltraps>
...
801064f5:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801064fa:	e9 5a f2 ff ff       	jmp    80105759 <alltraps>
...
80106501:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106506:	e9 4e f2 ff ff       	jmp    80105759 <alltraps>
...
8010650d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106512:	e9 42 f2 ff ff       	jmp    80105759 <alltraps>
...
80106519:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010651e:	e9 36 f2 ff ff       	jmp    80105759 <alltraps>
...
80106525:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010652a:	e9 2a f2 ff ff       	jmp    80105759 <alltraps>
...
80106531:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106536:	e9 1e f2 ff ff       	jmp    80105759 <alltraps>
...
8010653d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106542:	e9 12 f2 ff ff       	jmp    80105759 <alltraps>
...
80106549:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010654e:	e9 06 f2 ff ff       	jmp    80105759 <alltraps>
...
80106555:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010655a:	e9 fa f1 ff ff       	jmp    80105759 <alltraps>
...
80106561:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106566:	e9 ee f1 ff ff       	jmp    80105759 <alltraps>
...
8010656d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106572:	e9 e2 f1 ff ff       	jmp    80105759 <alltraps>
...
80106579:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010657e:	e9 d6 f1 ff ff       	jmp    80105759 <alltraps>
...
80106585:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010658a:	e9 ca f1 ff ff       	jmp    80105759 <alltraps>
...
80106591:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106596:	e9 be f1 ff ff       	jmp    80105759 <alltraps>
...
8010659d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801065a2:	e9 b2 f1 ff ff       	jmp    80105759 <alltraps>
...
801065a9:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801065ae:	e9 a6 f1 ff ff       	jmp    80105759 <alltraps>
...
801065b5:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801065ba:	e9 9a f1 ff ff       	jmp    80105759 <alltraps>
...
801065c1:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801065c6:	e9 8e f1 ff ff       	jmp    80105759 <alltraps>
...
801065cd:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
801065d2:	e9 82 f1 ff ff       	jmp    80105759 <alltraps>
...
801065d9:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
801065de:	e9 76 f1 ff ff       	jmp    80105759 <alltraps>
...
801065e5:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
801065ea:	e9 6a f1 ff ff       	jmp    80105759 <alltraps>
...
801065f1:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
801065f6:	e9 5e f1 ff ff       	jmp    80105759 <alltraps>
...
801065fd:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106602:	e9 52 f1 ff ff       	jmp    80105759 <alltraps>
...
80106609:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010660e:	e9 46 f1 ff ff       	jmp    80105759 <alltraps>
...
80106615:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010661a:	e9 3a f1 ff ff       	jmp    80105759 <alltraps>
...
80106621:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106626:	e9 2e f1 ff ff       	jmp    80105759 <alltraps>
...
8010662d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106632:	e9 22 f1 ff ff       	jmp    80105759 <alltraps>
...
80106639:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010663e:	e9 16 f1 ff ff       	jmp    80105759 <alltraps>
...
80106645:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010664a:	e9 0a f1 ff ff       	jmp    80105759 <alltraps>
...
80106651:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106656:	e9 fe f0 ff ff       	jmp    80105759 <alltraps>
...
8010665d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106662:	e9 f2 f0 ff ff       	jmp    80105759 <alltraps>
...
80106669:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010666e:	e9 e6 f0 ff ff       	jmp    80105759 <alltraps>
...
80106675:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010667a:	e9 da f0 ff ff       	jmp    80105759 <alltraps>
...
80106681:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106686:	e9 ce f0 ff ff       	jmp    80105759 <alltraps>
...
8010668d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106692:	e9 c2 f0 ff ff       	jmp    80105759 <alltraps>
...
801066fa:	e8 71 de ff ff       	call   80104570 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
8010679d:	68 34 7b 10 80       	push   $0x80107b34
...
801067cc:	73 6b                	jae    80106839 <deallocuvm.part.0+0x89>
801067ce:	89 d6                	mov    %edx,%esi
801067d0:	eb 42                	jmp    80106814 <deallocuvm.part.0+0x64>
...
801067dd:	74 2b                	je     8010680a <deallocuvm.part.0+0x5a>
      pa = PTE_ADDR(*pte);
      if(pa == 0)
801067df:	89 d1                	mov    %edx,%ecx
801067e1:	81 e1 00 f0 ff ff    	and    $0xfffff000,%ecx
801067e7:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
801067ea:	74 79                	je     80106865 <deallocuvm.part.0+0xb5>
        panic("kfree");
      char *v = P2V(pa);

      if(references[pa/PGSIZE] == 1)
801067ec:	c1 ea 0c             	shr    $0xc,%edx
801067ef:	0f b6 8a c0 54 18 80 	movzbl -0x7fe7ab40(%edx),%ecx
801067f6:	80 f9 01             	cmp    $0x1,%cl
801067f9:	74 4d                	je     80106848 <deallocuvm.part.0+0x98>
      	kfree(v);
      else
      	references[pa/PGSIZE] = references[pa/PGSIZE] -1;
801067fb:	83 e9 01             	sub    $0x1,%ecx
801067fe:	88 8a c0 54 18 80    	mov    %cl,-0x7fe7ab40(%edx)

      *pte = 0;
80106804:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(; a  < oldsz; a += PGSIZE){
8010680a:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106810:	39 f3                	cmp    %esi,%ebx
80106812:	73 25                	jae    80106839 <deallocuvm.part.0+0x89>
    pte = walkpgdir(pgdir, (char*)a, 0);
80106814:	31 c9                	xor    %ecx,%ecx
80106816:	89 da                	mov    %ebx,%edx
80106818:	89 f8                	mov    %edi,%eax
8010681a:	e8 81 fe ff ff       	call   801066a0 <walkpgdir>
    if(!pte)
8010681f:	85 c0                	test   %eax,%eax
80106821:	75 b5                	jne    801067d8 <deallocuvm.part.0+0x28>
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
80106823:	81 e3 00 00 c0 ff    	and    $0xffc00000,%ebx
80106829:	81 c3 00 f0 3f 00    	add    $0x3ff000,%ebx
  for(; a  < oldsz; a += PGSIZE){
8010682f:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106835:	39 f3                	cmp    %esi,%ebx
80106837:	72 db                	jb     80106814 <deallocuvm.part.0+0x64>
    }
    //references[pa/PGSIZE]--;
  }
  return newsz;
}
80106839:	8b 45 e0             	mov    -0x20(%ebp),%eax
...
8010684e:	89 45 dc             	mov    %eax,-0x24(%ebp)
      char *v = P2V(pa);
80106851:	81 c2 00 00 00 80    	add    $0x80000000,%edx
      	kfree(v);
80106857:	52                   	push   %edx
80106858:	e8 c3 ba ff ff       	call   80102320 <kfree>
8010685d:	83 c4 10             	add    $0x10,%esp
80106860:	8b 45 dc             	mov    -0x24(%ebp),%eax
80106863:	eb 9f                	jmp    80106804 <deallocuvm.part.0+0x54>
        panic("kfree");
80106865:	83 ec 0c             	sub    $0xc,%esp
80106868:	68 26 74 10 80       	push   $0x80107426
8010686d:	e8 1e 9b ff ff       	call   80100390 <panic>
...
8010689a:	c7 80 f8 27 18 80 ff 	movl   $0xffff,-0x7fe7d808(%eax)
801068a1:	ff 00 00 
801068a4:	c7 80 fc 27 18 80 00 	movl   $0xcf9a00,-0x7fe7d804(%eax)
801068ab:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801068ae:	c7 80 00 28 18 80 ff 	movl   $0xffff,-0x7fe7d800(%eax)
801068b5:	ff 00 00 
801068b8:	c7 80 04 28 18 80 00 	movl   $0xcf9200,-0x7fe7d7fc(%eax)
801068bf:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801068c2:	c7 80 08 28 18 80 ff 	movl   $0xffff,-0x7fe7d7f8(%eax)
801068c9:	ff 00 00 
801068cc:	c7 80 0c 28 18 80 00 	movl   $0xcffa00,-0x7fe7d7f4(%eax)
801068d3:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801068d6:	c7 80 10 28 18 80 ff 	movl   $0xffff,-0x7fe7d7f0(%eax)
801068dd:	ff 00 00 
801068e0:	c7 80 14 28 18 80 00 	movl   $0xcff200,-0x7fe7d7ec(%eax)
801068e7:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
801068ea:	05 f0 27 18 80       	add    $0x801827f0,%eax
  pd[1] = (uint)p;
...
80106910:	a1 c0 34 19 80       	mov    0x801934c0,%eax
{
...
80106954:	0f 84 c2 00 00 00    	je     80106a1c <switchuvm+0xec>
  pushcli();
8010695a:	e8 31 da ff ff       	call   80104390 <pushcli>
...
80106a49:	8b 7d 10             	mov    0x10(%ebp),%edi
  if(sz >= PGSIZE)
80106a4c:	81 ff ff 0f 00 00    	cmp    $0xfff,%edi
80106a52:	77 53                	ja     80106aa7 <inituvm+0x67>
  mem = kalloc();
...
80106a5c:	89 c6                	mov    %eax,%esi
  memset(mem, 0, PGSIZE);
80106a5e:	68 00 10 00 00       	push   $0x1000
80106a63:	6a 00                	push   $0x0
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
80106a65:	8d 9e 00 00 00 80    	lea    -0x80000000(%esi),%ebx
  memset(mem, 0, PGSIZE);
80106a6b:	50                   	push   %eax
80106a6c:	e8 ff da ff ff       	call   80104570 <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
80106a71:	58                   	pop    %eax
80106a72:	5a                   	pop    %edx
80106a73:	8b 45 08             	mov    0x8(%ebp),%eax
80106a76:	6a 06                	push   $0x6
80106a78:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106a7d:	53                   	push   %ebx
80106a7e:	31 d2                	xor    %edx,%edx
  references[V2P(mem)/PGSIZE]+=1;
80106a80:	c1 eb 0c             	shr    $0xc,%ebx
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
80106a83:	e8 98 fc ff ff       	call   80106720 <mappages>
  memmove(mem, init, sz);
80106a88:	83 c4 0c             	add    $0xc,%esp
80106a8b:	57                   	push   %edi
80106a8c:	ff 75 0c             	pushl  0xc(%ebp)
80106a8f:	56                   	push   %esi
80106a90:	e8 8b db ff ff       	call   80104620 <memmove>
  references[V2P(mem)/PGSIZE]+=1;
80106a95:	80 83 c0 54 18 80 01 	addb   $0x1,-0x7fe7ab40(%ebx)
}
...
80106aaa:	68 79 7b 10 80       	push   $0x80107b79
...
80106b8e:	0f 88 a7 00 00 00    	js     80106c3b <allocuvm+0xbb>
  if(newsz < oldsz)
80106b94:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80106b97:	0f 82 b3 00 00 00    	jb     80106c50 <allocuvm+0xd0>
  a = PGROUNDUP(oldsz);
...
80106baf:	0f 86 9e 00 00 00    	jbe    80106c53 <allocuvm+0xd3>
...
80106bcb:	e8 a0 d9 ff ff       	call   80104570 <memset>
...
80106be4:	e8 37 fb ff ff       	call   80106720 <mappages>
80106be9:	83 c4 10             	add    $0x10,%esp
80106bec:	85 c0                	test   %eax,%eax
80106bee:	78 70                	js     80106c60 <allocuvm+0xe0>
  for(; a < newsz; a += PGSIZE){
80106bf0:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106bf6:	39 5d 10             	cmp    %ebx,0x10(%ebp)
80106bf9:	0f 86 a1 00 00 00    	jbe    80106ca0 <allocuvm+0x120>
    mem = kalloc();
80106bff:	e8 cc b8 ff ff       	call   801024d0 <kalloc>
80106c04:	89 c6                	mov    %eax,%esi
    if(references[V2P(a)/PGSIZE] < 1)
80106c06:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106c0c:	c1 e8 0c             	shr    $0xc,%eax
80106c0f:	80 b8 c0 54 18 80 00 	cmpb   $0x0,-0x7fe7ab40(%eax)
80106c16:	7f 07                	jg     80106c1f <allocuvm+0x9f>
    	references[V2P(a)/PGSIZE] = 1;
80106c18:	c6 80 c0 54 18 80 01 	movb   $0x1,-0x7fe7ab40(%eax)
    if(mem == 0){
80106c1f:	85 f6                	test   %esi,%esi
80106c21:	75 9d                	jne    80106bc0 <allocuvm+0x40>
      cprintf("allocuvm out of memory\n");
80106c23:	83 ec 0c             	sub    $0xc,%esp
80106c26:	68 b1 7b 10 80       	push   $0x80107bb1
80106c2b:	e8 30 9a ff ff       	call   80100660 <cprintf>
  if(newsz >= oldsz)
80106c30:	83 c4 10             	add    $0x10,%esp
80106c33:	8b 45 0c             	mov    0xc(%ebp),%eax
80106c36:	39 45 10             	cmp    %eax,0x10(%ebp)
80106c39:	77 75                	ja     80106cb0 <allocuvm+0x130>
}
80106c3b:	8d 65 f4             	lea    -0xc(%ebp),%esp
    return 0;
80106c3e:	31 ff                	xor    %edi,%edi
}
80106c40:	89 f8                	mov    %edi,%eax
80106c42:	5b                   	pop    %ebx
80106c43:	5e                   	pop    %esi
80106c44:	5f                   	pop    %edi
80106c45:	5d                   	pop    %ebp
...
80106ca0:	8b 7d e4             	mov    -0x1c(%ebp),%edi
...
80106cb2:	8b 55 10             	mov    0x10(%ebp),%edx
80106cb5:	8b 45 08             	mov    0x8(%ebp),%eax
      return 0;
80106cb8:	31 ff                	xor    %edi,%edi
80106cba:	e8 f1 fa ff ff       	call   801067b0 <deallocuvm.part.0>
80106cbf:	eb 92                	jmp    80106c53 <allocuvm+0xd3>
80106cc1:	eb 0d                	jmp    80106cd0 <deallocuvm>
80106cc3:	90                   	nop
80106cc4:	90                   	nop
80106cc5:	90                   	nop
80106cc6:	90                   	nop
...
80106ce0:	5d                   	pop    %ebp
80106ce1:	e9 ca fa ff ff       	jmp    801067b0 <deallocuvm.part.0>
...
80106d19:	e8 92 fa ff ff       	call   801067b0 <deallocuvm.part.0>
...
80106d4e:	e8 cd b5 ff ff       	call   80102320 <kfree>
...
80106d63:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106d64:	e9 b7 b5 ff ff       	jmp    80102320 <kfree>
    panic("freevm: no pgdir");
80106d69:	83 ec 0c             	sub    $0xc,%esp
80106d6c:	68 e5 7b 10 80       	push   $0x80107be5
...
80106d85:	e8 46 b7 ff ff       	call   801024d0 <kalloc>
...
80106da0:	e8 cb d7 ff ff       	call   80104570 <memset>
...
80106dbb:	e8 60 f9 ff ff       	call   80106720 <mappages>
...
80106e0b:	a3 c0 34 19 80       	mov    %eax,0x801934c0
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106e2e:	e8 6d f8 ff ff       	call   801066a0 <walkpgdir>
  if(pte == 0)
...
80106e5e:	0f 88 a4 00 00 00    	js     80106f08 <handle_pgflt+0xb8>
80106e64:	e8 87 c9 ff ff       	call   801037f0 <myproc>
80106e69:	8b 40 04             	mov    0x4(%eax),%eax
80106e6c:	31 c9                	xor    %ecx,%ecx
80106e6e:	89 da                	mov    %ebx,%edx
80106e70:	e8 2b f8 ff ff       	call   801066a0 <walkpgdir>
80106e75:	85 c0                	test   %eax,%eax
80106e77:	89 c6                	mov    %eax,%esi
80106e79:	0f 84 89 00 00 00    	je     80106f08 <handle_pgflt+0xb8>
	//     myproc()->killed = 1;
	//     return;
	// }
	...
	if(*pte & PTE_W){
80106e7f:	8b 18                	mov    (%eax),%ebx
80106e81:	f6 c3 02             	test   $0x2,%bl
80106e84:	0f 85 ca 00 00 00    	jne    80106f54 <handle_pgflt+0x104>
...
80106e8a:	89 df                	mov    %ebx,%edi
80106e8c:	c1 ef 0c             	shr    $0xc,%edi

	if(cnt == 1){	
80106e8f:	80 bf c0 54 18 80 01 	cmpb   $0x1,-0x7fe7ab40(%edi)
80106e96:	0f 84 84 00 00 00    	je     80106f20 <handle_pgflt+0xd0>
    lcr3(V2P(myproc()->pgdir));
		...
		if((mem = kalloc()) == 0){
80106e9c:	e8 2f b6 ff ff       	call   801024d0 <kalloc>
80106ea1:	85 c0                	test   %eax,%eax
80106ea3:	89 c2                	mov    %eax,%edx
80106ea5:	0f 84 95 00 00 00    	je     80106f40 <handle_pgflt+0xf0>
  physcialAdd = PTE_ADDR(*pte);
...
80106ead:	83 ec 04             	sub    $0x4,%esp
80106eb0:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  physcialAdd = PTE_ADDR(*pte);
80106eb3:	25 00 f0 ff ff       	and    $0xfffff000,%eax
		memmove(mem,(char*)P2V(physcialAdd),PGSIZE);
80106eb8:	68 00 10 00 00       	push   $0x1000
  flags = PTE_FLAGS(*pte);
80106ebd:	81 e3 ff 0f 00 00    	and    $0xfff,%ebx
		memmove(mem,(char*)P2V(physcialAdd),PGSIZE);
80106ec3:	05 00 00 00 80       	add    $0x80000000,%eax
		...
		flags |= PTE_P;
		flags |= PTE_U;
80106ec8:	83 cb 07             	or     $0x7,%ebx
		memmove(mem,(char*)P2V(physcialAdd),PGSIZE);
80106ecb:	50                   	push   %eax
80106ecc:	52                   	push   %edx
80106ecd:	e8 4e d7 ff ff       	call   80104620 <memmove>
    // flags &= ~(0x800);

	//	cprintf("%d %d\n",V2P(mem)>>12,flags);

    *pte = V2P(mem);
80106ed2:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80106ed5:	81 c2 00 00 00 80    	add    $0x80000000,%edx
    *pte |= flags;
80106edb:	09 d3                	or     %edx,%ebx
80106edd:	89 1e                	mov    %ebx,(%esi)

    lcr3(V2P(myproc()->pgdir));
80106edf:	e8 0c c9 ff ff       	call   801037f0 <myproc>
80106ee4:	8b 40 04             	mov    0x4(%eax),%eax
80106ee7:	05 00 00 00 80       	add    $0x80000000,%eax
  asm volatile("movl %0,%%cr3" : : "r" (val));
80106eec:	0f 22 d8             	mov    %eax,%cr3
    // cprintf("%d\n",references[physcialAdd/PGSIZE]);
    references[physcialAdd/PGSIZE] = references[physcialAdd/PGSIZE] -1;
80106eef:	80 af c0 54 18 80 01 	subb   $0x1,-0x7fe7ab40(%edi)
...
80106ef9:	8d 65 f4             	lea    -0xc(%ebp),%esp
80106efc:	5b                   	pop    %ebx
80106efd:	5e                   	pop    %esi
80106efe:	5f                   	pop    %edi
80106eff:	5d                   	pop    %ebp
...
80106f0b:	68 00 7c 10 80       	push   $0x80107c00
80106f10:	e8 4b 97 ff ff       	call   80100660 <cprintf>
	if(*pte & PTE_W){
80106f15:	a1 00 00 00 00       	mov    0x0,%eax
80106f1a:	0f 0b                	ud2    
80106f1c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
		*pte |= PTE_W;
80106f20:	83 cb 02             	or     $0x2,%ebx
80106f23:	89 18                	mov    %ebx,(%eax)
    lcr3(V2P(myproc()->pgdir));
80106f25:	e8 c6 c8 ff ff       	call   801037f0 <myproc>
80106f2a:	8b 40 04             	mov    0x4(%eax),%eax
80106f2d:	05 00 00 00 80       	add    $0x80000000,%eax
80106f32:	0f 22 d8             	mov    %eax,%cr3
}
...
80106f3d:	8d 76 00             	lea    0x0(%esi),%esi
			myproc()->killed = 1;
80106f40:	e8 ab c8 ff ff       	call   801037f0 <myproc>
80106f45:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
}
...
80106f57:	68 10 7c 10 80       	push   $0x80107c10
80106f5c:	e8 2f 94 ff ff       	call   80100390 <panic>
80106f61:	eb 0d                	jmp    80106f70 <copyuvm_cow>
80106f63:	90                   	nop
80106f64:	90                   	nop
80106f65:	90                   	nop
80106f66:	90                   	nop
...
80106f76:	83 ec 1c             	sub    $0x1c,%esp
  ...
  if((d = setupkvm()) == 0)
80106f79:	e8 02 fe ff ff       	call   80106d80 <setupkvm>
80106f7e:	85 c0                	test   %eax,%eax
80106f80:	89 c7                	mov    %eax,%edi
80106f82:	0f 84 83 00 00 00    	je     8010700b <copyuvm_cow+0x9b>
    return 0;

  for(i = 0; i < sz; i += PGSIZE){
80106f88:	8b 45 0c             	mov    0xc(%ebp),%eax
80106f8b:	85 c0                	test   %eax,%eax
80106f8d:	74 7c                	je     8010700b <copyuvm_cow+0x9b>
...
80106f8f:	8b 45 08             	mov    0x8(%ebp),%eax
  for(i = 0; i < sz; i += PGSIZE){
80106f92:	31 f6                	xor    %esi,%esi
    lcr3(V2P(pgdir));
80106f94:	05 00 00 00 80       	add    $0x80000000,%eax
80106f99:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106f9c:	eb 1d                	jmp    80106fbb <copyuvm_cow+0x4b>
80106f9e:	66 90                	xchg   %ax,%ax
  	references[pa/PGSIZE]+=1;
80106fa0:	c1 eb 0c             	shr    $0xc,%ebx
80106fa3:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106fa6:	80 83 c0 54 18 80 01 	addb   $0x1,-0x7fe7ab40(%ebx)
80106fad:	0f 22 d8             	mov    %eax,%cr3
  for(i = 0; i < sz; i += PGSIZE){
80106fb0:	81 c6 00 10 00 00    	add    $0x1000,%esi
80106fb6:	39 75 0c             	cmp    %esi,0xc(%ebp)
80106fb9:	76 50                	jbe    8010700b <copyuvm_cow+0x9b>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106fbb:	8b 45 08             	mov    0x8(%ebp),%eax
80106fbe:	31 c9                	xor    %ecx,%ecx
80106fc0:	89 f2                	mov    %esi,%edx
80106fc2:	e8 d9 f6 ff ff       	call   801066a0 <walkpgdir>
80106fc7:	85 c0                	test   %eax,%eax
80106fc9:	74 57                	je     80107022 <copyuvm_cow+0xb2>
    if(!(*pte & PTE_P))
80106fcb:	8b 18                	mov    (%eax),%ebx
80106fcd:	f6 c3 01             	test   $0x1,%bl
80106fd0:	74 43                	je     80107015 <copyuvm_cow+0xa5>
    flags &= 0xFFD;
80106fd2:	89 d8                	mov    %ebx,%eax
    if(mappages(d, (void*)i, PGSIZE, pa, flags) < 0) {
80106fd4:	83 ec 08             	sub    $0x8,%esp
80106fd7:	b9 00 10 00 00       	mov    $0x1000,%ecx
    flags &= 0xFFD;
80106fdc:	25 fd 0f 00 00       	and    $0xffd,%eax
    if(mappages(d, (void*)i, PGSIZE, pa, flags) < 0) {
80106fe1:	89 f2                	mov    %esi,%edx
    flags &= 0xFFD;
80106fe3:	80 cc 08             	or     $0x8,%ah
    if(mappages(d, (void*)i, PGSIZE, pa, flags) < 0) {
80106fe6:	50                   	push   %eax
    pa = PTE_ADDR(*pte);
80106fe7:	89 d8                	mov    %ebx,%eax
80106fe9:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    if(mappages(d, (void*)i, PGSIZE, pa, flags) < 0) {
80106fee:	50                   	push   %eax
80106fef:	89 f8                	mov    %edi,%eax
80106ff1:	e8 2a f7 ff ff       	call   80106720 <mappages>
80106ff6:	83 c4 10             	add    $0x10,%esp
80106ff9:	85 c0                	test   %eax,%eax
80106ffb:	79 a3                	jns    80106fa0 <copyuvm_cow+0x30>
...
80107000:	57                   	push   %edi
  return 0;
80107001:	31 ff                	xor    %edi,%edi
  freevm(d);
80107003:	e8 f8 fc ff ff       	call   80106d00 <freevm>
  return 0;
...
80107018:	68 ee 77 10 80       	push   $0x801077ee
8010701d:	e8 6e 93 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80107022:	83 ec 0c             	sub    $0xc,%esp
80107025:	68 d4 77 10 80       	push   $0x801077d4
8010702a:	e8 61 93 ff ff       	call   80100390 <panic>
8010702f:	90                   	nop
...
*/
  if((d = setupkvm()) == 0)
8010703c:	e8 3f fd ff ff       	call   80106d80 <setupkvm>
80107041:	85 c0                	test   %eax,%eax
80107043:	89 c6                	mov    %eax,%esi
80107045:	74 5e                	je     801070a5 <copyuvm+0x75>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80107047:	85 ff                	test   %edi,%edi
80107049:	74 5a                	je     801070a5 <copyuvm+0x75>
8010704b:	31 db                	xor    %ebx,%ebx
8010704d:	eb 0b                	jmp    8010705a <copyuvm+0x2a>
8010704f:	90                   	nop
80107050:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80107056:	39 df                	cmp    %ebx,%edi
80107058:	76 4b                	jbe    801070a5 <copyuvm+0x75>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
8010705a:	8b 45 08             	mov    0x8(%ebp),%eax
8010705d:	31 c9                	xor    %ecx,%ecx
8010705f:	89 da                	mov    %ebx,%edx
80107061:	e8 3a f6 ff ff       	call   801066a0 <walkpgdir>
80107066:	85 c0                	test   %eax,%eax
80107068:	74 52                	je     801070bc <copyuvm+0x8c>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
8010706a:	8b 00                	mov    (%eax),%eax
8010706c:	a8 01                	test   $0x1,%al
8010706e:	74 3f                	je     801070af <copyuvm+0x7f>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
    flags = PTE_FLAGS(*pte);
...
80107072:	83 ec 08             	sub    $0x8,%esp
    pa = PTE_ADDR(*pte);
80107075:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    flags &= ~PTE_W;
8010707a:	81 e2 fd 0f 00 00    	and    $0xffd,%edx
    if(mappages(d, (void*)i, PGSIZE, pa, flags) < 0) {
80107080:	b9 00 10 00 00       	mov    $0x1000,%ecx
80107085:	52                   	push   %edx
80107086:	50                   	push   %eax
80107087:	89 da                	mov    %ebx,%edx
80107089:	89 f0                	mov    %esi,%eax
8010708b:	e8 90 f6 ff ff       	call   80106720 <mappages>
80107090:	83 c4 10             	add    $0x10,%esp
80107093:	85 c0                	test   %eax,%eax
80107095:	79 b9                	jns    80107050 <copyuvm+0x20>
    }
  }
  return d;
...
8010709a:	56                   	push   %esi
  return 0;
8010709b:	31 f6                	xor    %esi,%esi
  freevm(d);
8010709d:	e8 5e fc ff ff       	call   80106d00 <freevm>
  return 0;
801070a2:	83 c4 10             	add    $0x10,%esp
}
801070a5:	8d 65 f4             	lea    -0xc(%ebp),%esp
801070a8:	89 f0                	mov    %esi,%eax
801070aa:	5b                   	pop    %ebx
801070ab:	5e                   	pop    %esi
801070ac:	5f                   	pop    %edi
801070ad:	5d                   	pop    %ebp
...
801070b2:	68 ee 77 10 80       	push   $0x801077ee
801070b7:	e8 d4 92 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
801070bc:	83 ec 0c             	sub    $0xc,%esp
801070bf:	68 d4 77 10 80       	push   $0x801077d4
...
801070de:	e8 bd f5 ff ff       	call   801066a0 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
801070e5:	c9                   	leave  
  if((*pte & PTE_U) == 0)
801070e6:	89 c2                	mov    %eax,%edx
  return (char*)P2V(PTE_ADDR(*pte));
801070e8:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  if((*pte & PTE_U) == 0)
801070ed:	83 e2 05             	and    $0x5,%edx
  return (char*)P2V(PTE_ADDR(*pte));
801070f0:	05 00 00 00 80       	add    $0x80000000,%eax
801070f5:	83 fa 05             	cmp    $0x5,%edx
801070f8:	ba 00 00 00 00       	mov    $0x0,%edx
801070fd:	0f 45 c2             	cmovne %edx,%eax
}
80107100:	c3                   	ret    
80107101:	eb 0d                	jmp    80107110 <copyout>
80107103:	90                   	nop
80107104:	90                   	nop
80107105:	90                   	nop
80107106:	90                   	nop
...
80107124:	75 40                	jne    80107166 <copyout+0x56>
80107126:	eb 70                	jmp    80107198 <copyout+0x88>
80107128:	90                   	nop
80107129:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(pa0 == 0)
      return -1;
    n = PGSIZE - (va - va0);
80107130:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80107133:	89 f1                	mov    %esi,%ecx
80107135:	29 d1                	sub    %edx,%ecx
80107137:	81 c1 00 10 00 00    	add    $0x1000,%ecx
8010713d:	39 d9                	cmp    %ebx,%ecx
8010713f:	0f 47 cb             	cmova  %ebx,%ecx
    if(n > len)
      n = len;
    memmove(pa0 + (va - va0), buf, n);
80107142:	29 f2                	sub    %esi,%edx
80107144:	83 ec 04             	sub    $0x4,%esp
80107147:	01 d0                	add    %edx,%eax
80107149:	51                   	push   %ecx
8010714a:	57                   	push   %edi
8010714b:	50                   	push   %eax
8010714c:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
8010714f:	e8 cc d4 ff ff       	call   80104620 <memmove>
    len -= n;
    buf += n;
80107154:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
  while(len > 0){
80107157:	83 c4 10             	add    $0x10,%esp
    va = va0 + PGSIZE;
8010715a:	8d 96 00 10 00 00    	lea    0x1000(%esi),%edx
    buf += n;
80107160:	01 cf                	add    %ecx,%edi
  while(len > 0){
80107162:	29 cb                	sub    %ecx,%ebx
80107164:	74 32                	je     80107198 <copyout+0x88>
    va0 = (uint)PGROUNDDOWN(va);
80107166:	89 d6                	mov    %edx,%esi
    pa0 = uva2ka(pgdir, (char*)va0);
80107168:	83 ec 08             	sub    $0x8,%esp
    va0 = (uint)PGROUNDDOWN(va);
8010716b:	89 55 e4             	mov    %edx,-0x1c(%ebp)
8010716e:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    pa0 = uva2ka(pgdir, (char*)va0);
80107174:	56                   	push   %esi
80107175:	ff 75 08             	pushl  0x8(%ebp)
80107178:	e8 53 ff ff ff       	call   801070d0 <uva2ka>
    if(pa0 == 0)
