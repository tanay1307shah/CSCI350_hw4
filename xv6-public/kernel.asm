...
80101ed8:	68 02 7a 10 80       	push   $0x80107a02
...
80102332:	81 fb c4 34 12 80    	cmp    $0x801234c4,%ebx
...
80102ec7:	68 c4 34 12 80       	push   $0x801234c4
...
80103736:	68 95 77 10 80       	push   $0x80107795
...
801038bf:	68 c5 77 10 80       	push   $0x801077c5
801038c4:	50                   	push   %eax
801038c5:	e8 86 0e 00 00       	call   80104750 <safestrcpy>
  p->cwd = namei("/");
801038ca:	c7 04 24 ce 77 10 80 	movl   $0x801077ce,(%esp)
...
80103903:	68 ac 77 10 80       	push   $0x801077ac
...
801039c8:	e8 e3 35 00 00       	call   80106fb0 <copyuvm_cow>
...
80103d1d:	68 1d 78 10 80       	push   $0x8010781d
80103d22:	e8 69 c6 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103d27:	83 ec 0c             	sub    $0xc,%esp
80103d2a:	68 10 78 10 80       	push   $0x80107810
...
80103e39:	68 2f 78 10 80       	push   $0x8010782f
80103e3e:	e8 4d c5 ff ff       	call   80100390 <panic>
    panic("sleep");
80103e43:	83 ec 0c             	sub    $0xc,%esp
80103e46:	68 29 78 10 80       	push   $0x80107829
...
80104025:	53                   	push   %ebx
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104026:	bf 54 2d 11 80       	mov    $0x80112d54,%edi
{
...
8010403b:	83 f8 05             	cmp    $0x5,%eax
      ...
      state = "???";
8010403e:	b9 40 78 10 80       	mov    $0x80107840,%ecx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104043:	77 11                	ja     80104056 <procdump+0x36>
80104045:	8b 0c 85 f4 78 10 80 	mov    -0x7fef870c(,%eax,4),%ecx
      state = "???";
8010404c:	b8 40 78 10 80       	mov    $0x80107840,%eax
...
8010405e:	68 4b 78 10 80       	push   $0x8010784b
...
80104078:	68 63 7c 10 80       	push   $0x80107c63
...
80104103:	68 54 78 10 80       	push   $0x80107854
...
80104158:	68 9a 78 10 80       	push   $0x8010789a
8010415d:	e8 fe c4 ff ff       	call   80100660 <cprintf>
			cprintf("|\n");
80104162:	c7 04 24 9f 78 10 80 	movl   $0x8010789f,(%esp)
...
80104183:	81 ff 54 4c 11 80    	cmp    $0x80114c54,%edi
...
801041c9:	68 81 72 10 80       	push   $0x80107281
...
801041e2:	68 6e 78 10 80       	push   $0x8010786e
...
801041fa:	68 0c 79 10 80       	push   $0x8010790c
...
80104415:	68 17 79 10 80       	push   $0x80107917
8010441a:	e8 71 bf ff ff       	call   80100390 <panic>
    panic("popcli");
8010441f:	83 ec 0c             	sub    $0xc,%esp
80104422:	68 2e 79 10 80       	push   $0x8010792e
...
80104507:	68 35 79 10 80       	push   $0x80107935
...
8010455c:	68 3d 79 10 80       	push   $0x8010793d
...
8010497c:	8b 14 85 80 79 10 80 	mov    -0x7fef8680(,%eax,4),%edx
...
801049a0:	68 45 79 10 80       	push   $0x80107945
...
80104af4:	68 f8 79 10 80       	push   $0x801079f8
...
80104b0c:	68 f7 79 10 80       	push   $0x801079f7
...
80104b25:	68 eb 79 10 80       	push   $0x801079eb
...
80104b3a:	68 fa 79 10 80       	push   $0x801079fa
80104b3f:	e8 4c b8 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104b44:	83 ec 0c             	sub    $0xc,%esp
80104b47:	68 dc 79 10 80       	push   $0x801079dc
...
80104f39:	58                   	pop    %eax
80104f3a:	5a                   	pop    %edx
80104f3b:	68 f8 79 10 80       	push   $0x801079f8
...
80104f54:	68 f7 79 10 80       	push   $0x801079f7
...
801057ce:	00 00 ef 
  initlock(&tickslock, "time");
801057d1:	68 3d 7a 10 80       	push   $0x80107a3d
...
80105850:	ff 24 85 e4 7a 10 80 	jmp    *-0x7fef851c(,%eax,4)
...
801058b5:	68 a0 7a 10 80       	push   $0x80107aa0
...
801059ef:	68 48 7a 10 80       	push   $0x80107a48
...
80105a43:	68 60 4c 11 80       	push   $0x80114c60
80105a48:	e8 13 ea ff ff       	call   80104460 <acquire>
      wakeup(&ticks);
80105a4d:	c7 04 24 a0 54 11 80 	movl   $0x801154a0,(%esp)
      ticks++;
80105a54:	83 05 a0 54 11 80 01 	addl   $0x1,0x801154a0
      wakeup(&ticks);
80105a5b:	e8 e0 e4 ff ff       	call   80103f40 <wakeup>
      release(&tickslock);
80105a60:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
...
80105a88:	68 6c 7a 10 80       	push   $0x80107a6c
80105a8d:	e8 ce ab ff ff       	call   80100660 <cprintf>
      panic("trap");
80105a92:	83 c4 14             	add    $0x14,%esp
80105a95:	68 42 7a 10 80       	push   $0x80107a42
...
80105b8c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105b8f:	bb ac 7b 10 80       	mov    $0x80107bac,%ebx
  ioapicenable(IRQ_COM1, 0);
...
8010679d:	68 b4 7b 10 80       	push   $0x80107bb4
...
801067ef:	0f b6 8a c0 54 11 80 	movzbl -0x7feeab40(%edx),%ecx
801067f6:	80 f9 01             	cmp    $0x1,%cl
801067f9:	7e 4d                	jle    80106848 <deallocuvm.part.0+0x98>
      	references[pa/PGSIZE]-=1;
801067fb:	83 e9 01             	sub    $0x1,%ecx
801067fe:	88 8a c0 54 11 80    	mov    %cl,-0x7feeab40(%edx)
      else
      	kfree(v);
...
80106868:	68 a6 74 10 80       	push   $0x801074a6
...
8010689a:	c7 80 f8 27 11 80 ff 	movl   $0xffff,-0x7feed808(%eax)
801068a1:	ff 00 00 
801068a4:	c7 80 fc 27 11 80 00 	movl   $0xcf9a00,-0x7feed804(%eax)
801068ab:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801068ae:	c7 80 00 28 11 80 ff 	movl   $0xffff,-0x7feed800(%eax)
801068b5:	ff 00 00 
801068b8:	c7 80 04 28 11 80 00 	movl   $0xcf9200,-0x7feed7fc(%eax)
801068bf:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801068c2:	c7 80 08 28 11 80 ff 	movl   $0xffff,-0x7feed7f8(%eax)
801068c9:	ff 00 00 
801068cc:	c7 80 0c 28 11 80 00 	movl   $0xcffa00,-0x7feed7f4(%eax)
801068d3:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801068d6:	c7 80 10 28 11 80 ff 	movl   $0xffff,-0x7feed7f0(%eax)
801068dd:	ff 00 00 
801068e0:	c7 80 14 28 11 80 00 	movl   $0xcff200,-0x7feed7ec(%eax)
801068e7:	f2 cf 00 
...
80106910:	a1 c0 34 12 80       	mov    0x801234c0,%eax
{
...
80106a90:	e8 8b db ff ff       	call   80104620 <memmove>
  references[V2P(mem)/PGSIZE]+=1;
80106a95:	80 83 c0 54 11 80 01 	addb   $0x1,-0x7feeab40(%ebx)
}
...
80106aaa:	68 f9 7b 10 80       	push   $0x80107bf9
...
80106c63:	68 49 7c 10 80       	push   $0x80107c49
...
80106d6c:	68 65 7c 10 80       	push   $0x80107c65
...
80106e0b:	a3 c0 34 12 80       	mov    %eax,0x801234c0
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106e3f:	68 76 7c 10 80       	push   $0x80107c76
...
80106e5c:	68 80 7c 10 80       	push   $0x80107c80
80106e61:	e8 fa 97 ff ff       	call   80100660 <cprintf>
	pte = walkpgdir(myproc()->pgdir,start,0);
80106e66:	e8 85 c9 ff ff       	call   801037f0 <myproc>
80106e6b:	8b 40 04             	mov    0x4(%eax),%eax
	char *start = (char*)PGROUNDDOWN((uint)va);
80106e6e:	89 fa                	mov    %edi,%edx
	pte = walkpgdir(myproc()->pgdir,start,0);
80106e70:	31 c9                	xor    %ecx,%ecx
	char *start = (char*)PGROUNDDOWN((uint)va);
80106e72:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
	pte = walkpgdir(myproc()->pgdir,start,0);
80106e78:	e8 23 f8 ff ff       	call   801066a0 <walkpgdir>
	if(pte == 0)
...
80106e82:	89 c6                	mov    %eax,%esi
	if(pte == 0)
80106e84:	0f 84 ae 00 00 00    	je     80106f38 <handle_pgflt+0xe8>
		cprintf("Invalid address");


	if(myproc()->tf->err & FEC_WR){
80106e8a:	e8 61 c9 ff ff       	call   801037f0 <myproc>
80106e8f:	8b 40 18             	mov    0x18(%eax),%eax
80106e92:	f6 40 34 02          	testb  $0x2,0x34(%eax)
80106e96:	0f 84 84 00 00 00    	je     80106f20 <handle_pgflt+0xd0>
		
		if(!(*pte & 0x800)){
80106e9c:	8b 1e                	mov    (%esi),%ebx
80106e9e:	f6 c7 08             	test   $0x8,%bh
80106ea1:	74 7d                	je     80106f20 <handle_pgflt+0xd0>
	  	}
...
80106ea3:	89 da                	mov    %ebx,%edx
80106ea5:	81 c7 00 00 00 80    	add    $0x80000000,%edi
80106eab:	c1 ea 0c             	shr    $0xc,%edx

		if(cnt == 1){
80106eae:	80 ba c0 54 11 80 01 	cmpb   $0x1,-0x7feeab40(%edx)
80106eb5:	0f 84 95 00 00 00    	je     80106f50 <handle_pgflt+0x100>
			cprintf("%d\n",PTE_FLAGS(*pte));
	        *pte &= ~(0x800);
	        lcr3(V2P(va));
...
80106ebe:	89 55 e0             	mov    %edx,-0x20(%ebp)
80106ec1:	68 04 7d 10 80       	push   $0x80107d04
80106ec6:	e8 95 97 ff ff       	call   80100660 <cprintf>
			char* mem = kalloc();
80106ecb:	e8 00 b6 ff ff       	call   801024d0 <kalloc>
80106ed0:	89 c1                	mov    %eax,%ecx
	  	uint physcialAdd = PTE_ADDR(*pte);
80106ed2:	89 d8                	mov    %ebx,%eax
			memmove(mem,(char*)P2V(physcialAdd),PGSIZE);
80106ed4:	83 c4 0c             	add    $0xc,%esp
	  	uint physcialAdd = PTE_ADDR(*pte);
80106ed7:	25 00 f0 ff ff       	and    $0xfffff000,%eax
			memmove(mem,(char*)P2V(physcialAdd),PGSIZE);
80106edc:	68 00 10 00 00       	push   $0x1000
80106ee1:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
80106ee4:	05 00 00 00 80       	add    $0x80000000,%eax
	  	uint flags = PTE_FLAGS(*pte);
80106ee9:	81 e3 ff 0f 00 00    	and    $0xfff,%ebx
			memmove(mem,(char*)P2V(physcialAdd),PGSIZE);
80106eef:	50                   	push   %eax
80106ef0:	51                   	push   %ecx

			uint newPhysicalAdd = V2P(mem);

	        *pte = newPhysicalAdd | flags | PTE_P | PTE_W;
80106ef1:	83 cb 03             	or     $0x3,%ebx
			memmove(mem,(char*)P2V(physcialAdd),PGSIZE);
80106ef4:	e8 27 d7 ff ff       	call   80104620 <memmove>
			uint newPhysicalAdd = V2P(mem);
80106ef9:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80106efc:	81 c1 00 00 00 80    	add    $0x80000000,%ecx
	        *pte = newPhysicalAdd | flags | PTE_P | PTE_W;
80106f02:	09 cb                	or     %ecx,%ebx
80106f04:	89 1e                	mov    %ebx,(%esi)
  asm volatile("movl %0,%%cr3" : : "r" (val));
80106f06:	0f 22 df             	mov    %edi,%cr3

	         lcr3(V2P(va));

	         references[physcialAdd/PGSIZE]-=1;
80106f09:	8b 55 e0             	mov    -0x20(%ebp),%edx
80106f0c:	83 c4 10             	add    $0x10,%esp
80106f0f:	80 aa c0 54 11 80 01 	subb   $0x1,-0x7feeab40(%edx)
	else{
		myproc()->killed =1;
		return;
	}
...
80106f1e:	66 90                	xchg   %ax,%ax
		myproc()->killed =1;
80106f20:	e8 cb c8 ff ff       	call   801037f0 <myproc>
...
80106f3b:	68 95 7c 10 80       	push   $0x80107c95
80106f40:	e8 1b 97 ff ff       	call   80100660 <cprintf>
80106f45:	83 c4 10             	add    $0x10,%esp
80106f48:	e9 3d ff ff ff       	jmp    80106e8a <handle_pgflt+0x3a>
80106f4d:	8d 76 00             	lea    0x0(%esi),%esi
			cprintf("Page with just one reference, Making page writeable!\n");
80106f50:	83 ec 0c             	sub    $0xc,%esp
80106f53:	68 cc 7c 10 80       	push   $0x80107ccc
80106f58:	e8 03 97 ff ff       	call   80100660 <cprintf>
			cprintf("%d\n",PTE_FLAGS(*pte));
80106f5d:	58                   	pop    %eax
80106f5e:	8b 06                	mov    (%esi),%eax
80106f60:	5a                   	pop    %edx
80106f61:	25 ff 0f 00 00       	and    $0xfff,%eax
80106f66:	50                   	push   %eax
80106f67:	68 34 77 10 80       	push   $0x80107734
80106f6c:	e8 ef 96 ff ff       	call   80100660 <cprintf>
			*pte |= PTE_W;
80106f71:	8b 06                	mov    (%esi),%eax
80106f73:	89 c2                	mov    %eax,%edx
			cprintf("%d\n",PTE_FLAGS(*pte));
80106f75:	25 ff 0f 00 00       	and    $0xfff,%eax
			*pte |= PTE_W;
80106f7a:	83 ca 02             	or     $0x2,%edx
			cprintf("%d\n",PTE_FLAGS(*pte));
80106f7d:	83 c8 02             	or     $0x2,%eax
			*pte |= PTE_W;
80106f80:	89 16                	mov    %edx,(%esi)
			cprintf("%d\n",PTE_FLAGS(*pte));
80106f82:	59                   	pop    %ecx
80106f83:	5b                   	pop    %ebx
80106f84:	50                   	push   %eax
80106f85:	68 34 77 10 80       	push   $0x80107734
80106f8a:	e8 d1 96 ff ff       	call   80100660 <cprintf>
	        *pte &= ~(0x800);
80106f8f:	81 26 ff f7 ff ff    	andl   $0xfffff7ff,(%esi)
80106f95:	0f 22 df             	mov    %edi,%cr3
...
80106fb6:	83 ec 1c             	sub    $0x1c,%esp
  ...
  if((d = setupkvm()) == 0)
80106fb9:	e8 c2 fd ff ff       	call   80106d80 <setupkvm>
80106fbe:	85 c0                	test   %eax,%eax
80106fc0:	89 c7                	mov    %eax,%edi
80106fc2:	0f 84 81 00 00 00    	je     80107049 <copyuvm_cow+0x99>
    return 0;
...
80106fcd:	74 7a                	je     80107049 <copyuvm_cow+0x99>
...
80106fcf:	8b 45 08             	mov    0x8(%ebp),%eax
  for(i = 0; i < sz; i += PGSIZE){
80106fd2:	31 f6                	xor    %esi,%esi
    lcr3(V2P(pgdir));
80106fd4:	05 00 00 00 80       	add    $0x80000000,%eax
80106fd9:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106fdc:	eb 1d                	jmp    80106ffb <copyuvm_cow+0x4b>
80106fde:	66 90                	xchg   %ax,%ax
  	references[pa/PGSIZE]+=1;
80106fe0:	c1 eb 0c             	shr    $0xc,%ebx
80106fe3:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106fe6:	80 83 c0 54 11 80 01 	addb   $0x1,-0x7feeab40(%ebx)
80106fed:	0f 22 d8             	mov    %eax,%cr3
  for(i = 0; i < sz; i += PGSIZE){
80106ff0:	81 c6 00 10 00 00    	add    $0x1000,%esi
80106ff6:	39 75 0c             	cmp    %esi,0xc(%ebp)
80106ff9:	76 4e                	jbe    80107049 <copyuvm_cow+0x99>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106ffb:	8b 45 08             	mov    0x8(%ebp),%eax
80106ffe:	31 c9                	xor    %ecx,%ecx
80107000:	89 f2                	mov    %esi,%edx
80107002:	e8 99 f6 ff ff       	call   801066a0 <walkpgdir>
80107007:	85 c0                	test   %eax,%eax
80107009:	74 55                	je     80107060 <copyuvm_cow+0xb0>
    if(!(*pte & PTE_P))
8010700b:	8b 00                	mov    (%eax),%eax
8010700d:	a8 01                	test   $0x1,%al
8010700f:	74 42                	je     80107053 <copyuvm_cow+0xa3>
    pa = PTE_ADDR(*pte);
80107011:	89 c3                	mov    %eax,%ebx
    if(mappages(d, (void*)i, PGSIZE, pa, flags) < 0) {
80107013:	83 ec 08             	sub    $0x8,%esp
    flags &= ~PTE_W;
80107016:	25 fd 0f 00 00       	and    $0xffd,%eax
    pa = PTE_ADDR(*pte);
8010701b:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
    if(mappages(d, (void*)i, PGSIZE, pa, flags) < 0) {
80107021:	50                   	push   %eax
80107022:	b9 00 10 00 00       	mov    $0x1000,%ecx
    pa |= 0x800; // pa | 1000 0000 0000
80107027:	80 cf 08             	or     $0x8,%bh
    if(mappages(d, (void*)i, PGSIZE, pa, flags) < 0) {
8010702a:	89 f2                	mov    %esi,%edx
8010702c:	89 f8                	mov    %edi,%eax
8010702e:	53                   	push   %ebx
8010702f:	e8 ec f6 ff ff       	call   80106720 <mappages>
80107034:	83 c4 10             	add    $0x10,%esp
80107037:	85 c0                	test   %eax,%eax
80107039:	79 a5                	jns    80106fe0 <copyuvm_cow+0x30>
...
8010703e:	57                   	push   %edi
  return 0;
8010703f:	31 ff                	xor    %edi,%edi
  freevm(d);
80107041:	e8 ba fc ff ff       	call   80106d00 <freevm>
  return 0;
80107046:	83 c4 10             	add    $0x10,%esp
}
80107049:	8d 65 f4             	lea    -0xc(%ebp),%esp
8010704c:	89 f8                	mov    %edi,%eax
8010704e:	5b                   	pop    %ebx
8010704f:	5e                   	pop    %esi
80107050:	5f                   	pop    %edi
80107051:	5d                   	pop    %ebp
...
80107056:	68 6e 78 10 80       	push   $0x8010786e
8010705b:	e8 30 93 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80107060:	83 ec 0c             	sub    $0xc,%esp
80107063:	68 54 78 10 80       	push   $0x80107854
...
80107076:	83 ec 1c             	sub    $0x1c,%esp
  ...
  if((d = setupkvm()) == 0)
80107079:	e8 02 fd ff ff       	call   80106d80 <setupkvm>
...
801070b0:	e8 6b d5 ff ff       	call   80104620 <memmove>
...
801070cb:	e8 50 f6 ff ff       	call   80106720 <mappages>
...
801070e9:	e8 b2 f5 ff ff       	call   801066a0 <walkpgdir>
...
80107119:	e8 e2 fb ff ff       	call   80106d00 <freevm>
  return 0;
...
80107149:	68 6e 78 10 80       	push   $0x8010786e
8010714e:	e8 3d 92 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80107153:	83 ec 0c             	sub    $0xc,%esp
80107156:	68 54 78 10 80       	push   $0x80107854
...
8010716e:	e8 2d f5 ff ff       	call   801066a0 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
801071df:	e8 3c d4 ff ff       	call   80104620 <memmove>
    len -= n;
    buf += n;
