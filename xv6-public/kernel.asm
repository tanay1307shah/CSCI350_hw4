...
801003c0:	e8 9b 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003c5:	c7 04 24 5b 7a 10 80 	movl   $0x80107a5b,(%esp)
...
80101ed8:	68 42 78 10 80       	push   $0x80107842
...
80103736:	68 d5 75 10 80       	push   $0x801075d5
...
80103d1d:	68 5d 76 10 80       	push   $0x8010765d
80103d22:	e8 69 c6 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103d27:	83 ec 0c             	sub    $0xc,%esp
80103d2a:	68 50 76 10 80       	push   $0x80107650
...
80103e39:	68 6f 76 10 80       	push   $0x8010766f
80103e3e:	e8 4d c5 ff ff       	call   80100390 <panic>
    panic("sleep");
80103e43:	83 ec 0c             	sub    $0xc,%esp
80103e46:	68 69 76 10 80       	push   $0x80107669
...
80103ee2:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103ee9:	e8 d2 2d 00 00       	call   80106cc0 <freevm>
        release(&ptable.lock);
...
8010403b:	83 f8 05             	cmp    $0x5,%eax
      ...
      state = "???";
8010403e:	b9 80 76 10 80       	mov    $0x80107680,%ecx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104043:	77 11                	ja     80104056 <procdump+0x36>
80104045:	8b 0c 85 34 77 10 80 	mov    -0x7fef88cc(,%eax,4),%ecx
      state = "???";
8010404c:	b8 80 76 10 80       	mov    $0x80107680,%eax
...
8010405e:	68 8b 76 10 80       	push   $0x8010768b
...
80104078:	68 5b 7a 10 80       	push   $0x80107a5b
...
80104103:	68 94 76 10 80       	push   $0x80107694
...
80104158:	68 da 76 10 80       	push   $0x801076da
8010415d:	e8 fe c4 ff ff       	call   80100660 <cprintf>
			cprintf("|\n");
80104162:	c7 04 24 df 76 10 80 	movl   $0x801076df,(%esp)
...
801041c9:	68 c1 70 10 80       	push   $0x801070c1
...
801041e2:	68 ae 76 10 80       	push   $0x801076ae
...
801041fa:	68 4c 77 10 80       	push   $0x8010774c
...
80104415:	68 57 77 10 80       	push   $0x80107757
8010441a:	e8 71 bf ff ff       	call   80100390 <panic>
    panic("popcli");
8010441f:	83 ec 0c             	sub    $0xc,%esp
80104422:	68 6e 77 10 80       	push   $0x8010776e
...
80104507:	68 75 77 10 80       	push   $0x80107775
...
8010455c:	68 7d 77 10 80       	push   $0x8010777d
...
8010497c:	8b 14 85 c0 77 10 80 	mov    -0x7fef8840(,%eax,4),%edx
...
801049a0:	68 85 77 10 80       	push   $0x80107785
...
80104af4:	68 38 78 10 80       	push   $0x80107838
...
80104b0c:	68 37 78 10 80       	push   $0x80107837
...
80104b25:	68 2b 78 10 80       	push   $0x8010782b
...
80104b3a:	68 3a 78 10 80       	push   $0x8010783a
80104b3f:	e8 4c b8 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104b44:	83 ec 0c             	sub    $0xc,%esp
80104b47:	68 1c 78 10 80       	push   $0x8010781c
...
80104f39:	58                   	pop    %eax
80104f3a:	5a                   	pop    %edx
80104f3b:	68 38 78 10 80       	push   $0x80107838
...
80104f54:	68 37 78 10 80       	push   $0x80107837
...
801057ce:	00 00 ef 
  initlock(&tickslock, "time");
801057d1:	68 7d 78 10 80       	push   $0x8010787d
...
80105850:	ff 24 85 24 79 10 80 	jmp    *-0x7fef86dc(,%eax,4)
...
801058b5:	68 e0 78 10 80       	push   $0x801078e0
...
801059f7:	68 88 78 10 80       	push   $0x80107888
...
80105a64:	83 05 a0 54 11 80 01 	addl   $0x1,0x801154a0
      wakeup(&ticks);
80105a6b:	e8 d0 e4 ff ff       	call   80103f40 <wakeup>
      release(&tickslock);
...
80105a95:	68 ac 78 10 80       	push   $0x801078ac
80105a9a:	e8 c1 ab ff ff       	call   80100660 <cprintf>
      panic("trap");
80105a9f:	83 c4 14             	add    $0x14,%esp
80105aa2:	68 82 78 10 80       	push   $0x80107882
...
80105b9c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105b9f:	bb a4 79 10 80       	mov    $0x801079a4,%ebx
  ioapicenable(IRQ_COM1, 0);
...
801067ad:	68 ac 79 10 80       	push   $0x801079ac
...
80106852:	68 e6 72 10 80       	push   $0x801072e6
...
801069a1:	e8 aa cd ff ff       	call   80103750 <mycpu>
...
801069b9:	e8 92 cd ff ff       	call   80103750 <mycpu>
801069be:	81 c6 00 10 00 00    	add    $0x1000,%esi
801069c4:	89 70 0c             	mov    %esi,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
801069c7:	e8 84 cd ff ff       	call   80103750 <mycpu>
...
80106a89:	68 f1 79 10 80       	push   $0x801079f1
...
80106bed:	68 29 7a 10 80       	push   $0x80107a29
...
80106c23:	68 41 7a 10 80       	push   $0x80107a41
...
80106d2c:	68 5d 7a 10 80       	push   $0x80107a5d
...
80106e19:	8b 7d 0c             	mov    0xc(%ebp),%edi
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  // char *mem;
  ...
  if((d = setupkvm()) == 0)
80106e1c:	e8 1f ff ff ff       	call   80106d40 <setupkvm>
80106e21:	85 c0                	test   %eax,%eax
80106e23:	89 c6                	mov    %eax,%esi
80106e25:	74 63                	je     80106e8a <copyuvm_cow+0x7a>
    return 0;
  ...
  for(i = 0; i < sz; i += PGSIZE){
80106e27:	85 ff                	test   %edi,%edi
80106e29:	74 5f                	je     80106e8a <copyuvm_cow+0x7a>
80106e2b:	31 db                	xor    %ebx,%ebx
80106e2d:	eb 0b                	jmp    80106e3a <copyuvm_cow+0x2a>
80106e2f:	90                   	nop
80106e30:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106e36:	39 df                	cmp    %ebx,%edi
80106e38:	76 50                	jbe    80106e8a <copyuvm_cow+0x7a>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106e3a:	8b 45 08             	mov    0x8(%ebp),%eax
80106e3d:	31 c9                	xor    %ecx,%ecx
80106e3f:	89 da                	mov    %ebx,%edx
80106e41:	e8 6a f8 ff ff       	call   801066b0 <walkpgdir>
80106e46:	85 c0                	test   %eax,%eax
80106e48:	74 57                	je     80106ea1 <copyuvm_cow+0x91>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
80106e4a:	8b 00                	mov    (%eax),%eax
80106e4c:	a8 01                	test   $0x1,%al
80106e4e:	74 44                	je     80106e94 <copyuvm_cow+0x84>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
...
80106e52:	83 ec 08             	sub    $0x8,%esp
    flags &= ~PTE_W;
80106e55:	25 fd 0f 00 00       	and    $0xffd,%eax
    pa = PTE_ADDR(*pte);
80106e5a:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
    if(mappages(d, (void*)i, PGSIZE, pa, flags) < 0) {
...
80106e68:	89 da                	mov    %ebx,%edx
    pa |= 0x800; // pa | 1000 0000 0000
80106e6a:	80 cc 08             	or     $0x8,%ah
    if(mappages(d, (void*)i, PGSIZE, pa, flags) < 0) {
80106e6d:	50                   	push   %eax
80106e6e:	89 f0                	mov    %esi,%eax
80106e70:	e8 bb f8 ff ff       	call   80106730 <mappages>
80106e75:	83 c4 10             	add    $0x10,%esp
80106e78:	85 c0                	test   %eax,%eax
80106e7a:	79 b4                	jns    80106e30 <copyuvm_cow+0x20>
...
80106e7f:	56                   	push   %esi
  return 0;
80106e80:	31 f6                	xor    %esi,%esi
  freevm(d);
80106e82:	e8 39 fe ff ff       	call   80106cc0 <freevm>
  return 0;
...
80106e97:	68 ae 76 10 80       	push   $0x801076ae
80106e9c:	e8 ef 94 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80106ea1:	83 ec 0c             	sub    $0xc,%esp
80106ea4:	68 94 76 10 80       	push   $0x80107694
...
80106eb6:	83 ec 1c             	sub    $0x1c,%esp
  ...
  if((d = setupkvm()) == 0)
80106eb9:	e8 82 fe ff ff       	call   80106d40 <setupkvm>
...
80106ef0:	e8 2b d7 ff ff       	call   80104620 <memmove>
...
80106f0b:	e8 20 f8 ff ff       	call   80106730 <mappages>
...
80106f29:	e8 82 f7 ff ff       	call   801066b0 <walkpgdir>
...
80106f59:	e8 62 fd ff ff       	call   80106cc0 <freevm>
  return 0;
...
80106f89:	68 ae 76 10 80       	push   $0x801076ae
80106f8e:	e8 fd 93 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80106f93:	83 ec 0c             	sub    $0xc,%esp
80106f96:	68 94 76 10 80       	push   $0x80107694
...
80106fae:	e8 fd f6 ff ff       	call   801066b0 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
8010701f:	e8 fc d5 ff ff       	call   80104620 <memmove>
    len -= n;
    buf += n;
