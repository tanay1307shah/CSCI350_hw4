...
int main()
{
  ...
  1d:	89 c3                	mov    %eax,%ebx
	printf(1,"cow test.\n");
  1f:	58                   	pop    %eax
  20:	68 98 07 00 00       	push   $0x798
  25:	6a 01                	push   $0x1
  27:	e8 14 04 00 00       	call   440 <printf>

	procdump();
  2c:	e8 61 03 00 00       	call   392 <procdump>
    // son
	if((pid = fork())==0)
  31:	e8 b4 02 00 00       	call   2ea <fork>
  ...
  3d:	52                   	push   %edx
  3e:	52                   	push   %edx
  3f:	68 a4 07 00 00       	push   $0x7a4
  44:	6a 01                	push   $0x1
  46:	e8 f5 03 00 00       	call   440 <printf>
		procdump();
  4b:	e8 42 03 00 00       	call   392 <procdump>
  ...
  73:	e8 c8 03 00 00       	call   440 <printf>
		procdump();
  78:	e8 15 03 00 00       	call   392 <procdump>
		exit();	
  7d:	e8 70 02 00 00       	call   2f2 <exit>
	}
	// parent
	else
		wait();
  82:	e8 73 02 00 00       	call   2fa <wait>

	free(space);
  87:	83 ec 0c             	sub    $0xc,%esp
  8a:	53                   	push   %ebx
  8b:	e8 80 05 00 00       	call   610 <free>
	exit();
  90:	e8 5d 02 00 00       	call   2f2 <exit>
  95:	66 90                	xchg   %ax,%ax
  97:	66 90                	xchg   %ax,%ax
  99:	66 90                	xchg   %ax,%ax
  9b:	66 90                	xchg   %ax,%ax
...
printf(int fd, const char *fmt, ...)
{
 ...
 5f4:	e9 8f fe ff ff       	jmp    488 <printf+0x48>
          s = "(null)";
 5f9:	bb f4 07 00 00       	mov    $0x7f4,%ebx
        while(*s != 0){
 ...
 611:	a1 a4 0a 00 00       	mov    0xaa4,%eax
{
 ...
 64d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 64f:	a3 a4 0a 00 00       	mov    %eax,0xaa4
}
 654:	5b                   	pop    %ebx
 655:	5e                   	pop    %esi
 656:	5f                   	pop    %edi
 ...
 666:	72 ce                	jb     636 <free+0x26>
{
 ...
 687:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 68a:	a3 a4 0a 00 00       	mov    %eax,0xaa4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 15 a4 0a 00 00    	mov    0xaa4,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ef:	73 47                	jae    738 <malloc+0x98>
    ...
    if(p == freep)
 6f1:	39 05 a4 0a 00 00    	cmp    %eax,0xaa4
 ...
 716:	e8 f5 fe ff ff       	call   610 <free>
  return freep;
 71b:	8b 15 a4 0a 00 00    	mov    0xaa4,%edx
 ...
 744:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 747:	89 15 a4 0a 00 00    	mov    %edx,0xaa4
}
 ...
 767:	0a 00 00 
 76a:	c7 05 a8 0a 00 00 a8 	movl   $0xaa8,0xaa8
 771:	0a 00 00 
    base.s.size = 0;
 774:	b8 a8 0a 00 00       	mov    $0xaa8,%eax
